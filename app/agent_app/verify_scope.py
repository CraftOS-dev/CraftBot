...
<agent_app_dir>/_verify/<project_id>/. The builder agent never sees or
...
def verify_store_dir(project) -> Path:
    """<agent_app_dir>/_verify/<project_id> — the project's own dir is
    <agent_app_dir>/<slug>_<id>, so its parent is the agent_app root."""
