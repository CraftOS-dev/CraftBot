...
@action(
    ...
    input_schema={
        ...
        "parse_mode": {"type": "string", "description": "Optional parse mode: HTML or MarkdownV2.", "example": "HTML"},
        "reply_to_message_id": {"type": "integer", "description": "Optional message to reply to.", "example": 42},
        "disable_web_page_preview": {"type": "boolean", "description": "Disable link previews.", "example": False},
        "reply_markup": {"type": "object", "description": "Optional reply markup (inline keyboard etc.).", "example": {}},
    },
    output_schema={
...
@action(
    ...
    input_schema={
        ...
        "parse_mode": {"type": "string", "description": "HTML or MarkdownV2.", "example": "HTML"},
        "reply_to_message_id": {"type": "integer", "description": "Reply target message id.", "example": 42},
        "disable_web_page_preview": {"type": "boolean", "description": "Disable preview.", "example": False},
        "disable_notification": {"type": "boolean", "description": "Send silently.", "example": False},
        "reply_markup": {"type": "object", "description": "Reply markup.", "example": {}},
    },
...
@action(
    ...
    input_schema={
        ...
        "parse_mode": {"type": "string", "description": "Parse mode.", "example": "HTML"},
        "reply_markup": {"type": "object", "description": "New reply markup.", "example": {}},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "message_id": {"type": "integer", "description": "Message ID.", "example": 42},
        "caption": {"type": "string", "description": "New caption.", "example": "New caption"},
        "parse_mode": {"type": "string", "description": "Parse mode.", "example": "HTML"},
        "reply_markup": {"type": "object", "description": "Reply markup.", "example": {}},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
async def edit_telegram_message_caption(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "edit_message_caption",
        chat_id=input_data["chat_id"],
        message_id=input_data["message_id"],
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "message_ids": {"type": "array", "description": "List of message IDs.", "example": [1, 2, 3]},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["telegram_messages"],
    input_schema={
        "chat_id": {"type": "string", "description": "Destination chat.", "example": "123"},
        "from_chat_id": {"type": "string", "description": "Source chat.", "example": "456"},
        "message_id": {"type": "integer", "description": "Source message ID.", "example": 42},
        "caption": {"type": "string", "description": "Optional new caption.", "example": "Copied"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "message_id": {"type": "integer", "description": "Message ID.", "example": 42},
        "disable_notification": {"type": "boolean", "description": "Silent pin.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "message_id": {"type": "integer", "description": "Optional message ID.", "example": 42},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
async def unpin_all_telegram_messages(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "unpin_all_messages",
        chat_id=input_data["chat_id"],
    )
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "message_id": {"type": "integer", "description": "Message ID.", "example": 42},
        "reactions": {"type": "array", "description": "Array of reaction objects, e.g. [{type:'emoji', emoji:'👍'}].", "example": [{"type": "emoji", "emoji": "👍"}]},
        "is_big": {"type": "boolean", "description": "Animated big reaction.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "action_type": {"type": "string", "description": "typing | upload_photo | record_video | upload_video | record_voice | upload_voice | upload_document | choose_sticker | find_location | record_video_note | upload_video_note.", "example": "typing"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "photo": {"type": "string", "description": "URL or file_id.", "example": "https://example.com/p.jpg"},
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "video": {"type": "string", "description": "File ID or URL.", "example": "https://example.com/v.mp4"},
        "caption": {"type": "string", "description": "Caption.", "example": ""},
        "duration": {"type": "integer", "description": "Duration in seconds.", "example": 30},
        "supports_streaming": {"type": "boolean", "description": "Streaming-capable.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "audio": {"type": "string", "description": "File ID or URL.", "example": "https://example.com/a.mp3"},
        "caption": {"type": "string", "description": "Caption.", "example": ""},
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "voice": {"type": "string", "description": "File ID or URL.", "example": "https://example.com/v.ogg"},
        "caption": {"type": "string", "description": "Caption.", "example": ""},
        "duration": {"type": "integer", "description": "Duration in seconds.", "example": 10},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "video_note": {"type": "string", "description": "File ID or URL.", "example": "https://example.com/note.mp4"},
        "duration": {"type": "integer", "description": "Duration in seconds.", "example": 10},
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "animation": {"type": "string", "description": "File ID or URL.", "example": "https://example.com/anim.gif"},
        "caption": {"type": "string", "description": "Caption.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "sticker": {"type": "string", "description": "File ID or URL or emoji.", "example": "CAACAgQA..."},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "live_period": {"type": "integer", "description": "Live location duration in seconds.", "example": 60},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "address": {"type": "string", "description": "Venue address.", "example": "1 Main St"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "phone_number": {"type": "string", "description": "Phone number.", "example": "+15551234567"},
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "emoji": {"type": "string", "description": "One of 🎲 🎯 🏀 ⚽ 🎳 🎰.", "example": "🎲"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "question": {"type": "string", "description": "Poll question.", "example": "Best language?"},
        "options": {"type": "array", "description": "Poll option strings.", "example": ["Python", "Go", "Rust"]},
        "is_anonymous": {"type": "boolean", "description": "Anonymous poll.", "example": True},
        "type": {"type": "string", "description": "quiz | regular.", "example": "regular"},
        "allows_multiple_answers": {"type": "boolean", "description": "Allow multi-select.", "example": False},
        "correct_option_id": {"type": "integer", "description": "Quiz correct option index.", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "message_id": {"type": "integer", "description": "Poll message ID.", "example": 42},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "media": {"type": "array", "description": "Array of InputMedia objects (type, media, caption).", "example": [{"type": "photo", "media": "https://example.com/1.jpg"}, {"type": "photo", "media": "https://example.com/2.jpg"}]},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "file_id": {"type": "string", "description": "File ID.", "example": "AgAC..."},
        "dest_path": {"type": "string", "description": "Local file path to save to.", "example": "/tmp/file.bin"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
async def get_telegram_chat_administrators(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "get_chat_administrators", chat_id=input_data["chat_id"],
    )
...
@action(
    ...
    input_schema={
        ...
        "until_date": {"type": "integer", "description": "Unix timestamp ban-until (0 = forever).", "example": 0},
        "revoke_messages": {"type": "boolean", "description": "Delete all messages from user.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "user_id": {"type": "integer", "description": "User ID.", "example": 987654321},
        "only_if_banned": {"type": "boolean", "description": "Only if currently banned.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "user_id": {"type": "integer", "description": "User ID.", "example": 987654321},
        "permissions": {"type": "object", "description": "ChatPermissions object.", "example": {"can_send_messages": False}},
        "until_date": {"type": "integer", "description": "Unix timestamp restrict-until.", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def restrict_telegram_chat_member(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "restrict_chat_member",
        chat_id=input_data["chat_id"],
        user_id=input_data["user_id"],
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "user_id": {"type": "integer", "description": "User ID.", "example": 987654321},
        "is_anonymous": {"type": "boolean", "description": "Anonymous admin.", "example": False},
        "can_manage_chat": {"type": "boolean", "description": "Manage chat privilege.", "example": True},
        "can_delete_messages": {"type": "boolean", "description": "Delete messages.", "example": True},
        "can_manage_video_chats": {"type": "boolean", "description": "Manage video chats.", "example": False},
        "can_restrict_members": {"type": "boolean", "description": "Restrict members.", "example": True},
        "can_promote_members": {"type": "boolean", "description": "Promote members.", "example": False},
        "can_change_info": {"type": "boolean", "description": "Change chat info.", "example": False},
        "can_invite_users": {"type": "boolean", "description": "Invite users.", "example": True},
        "can_post_messages": {"type": "boolean", "description": "Channel post.", "example": False},
        "can_edit_messages": {"type": "boolean", "description": "Channel edit.", "example": False},
        "can_pin_messages": {"type": "boolean", "description": "Pin messages.", "example": False},
        "can_manage_topics": {"type": "boolean", "description": "Manage forum topics.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def promote_telegram_chat_member(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "promote_chat_member",
        chat_id=input_data["chat_id"],
        user_id=input_data["user_id"],
        is_anonymous=input_data.get("is_anonymous"),
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "user_id": {"type": "integer", "description": "Admin user ID.", "example": 987654321},
        "custom_title": {"type": "string", "description": "Custom title (max 16 chars).", "example": "Owner"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def set_telegram_chat_administrator_custom_title(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "set_chat_administrator_custom_title",
        chat_id=input_data["chat_id"],
        user_id=input_data["user_id"],
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "permissions": {"type": "object", "description": "ChatPermissions object.", "example": {"can_send_messages": True}},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def set_telegram_chat_permissions(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "set_chat_permissions",
        chat_id=input_data["chat_id"],
        permissions=input_data["permissions"],
    )
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "title": {"type": "string", "description": "New title (1-128 chars).", "example": "New Chat Name"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "description": {"type": "string", "description": "New description (0-255 chars).", "example": "About this chat"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def set_telegram_chat_description(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "set_chat_description",
        chat_id=input_data["chat_id"],
...
async def delete_telegram_chat_photo(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "delete_chat_photo",
        chat_id=input_data["chat_id"],
    )
...
async def export_telegram_chat_invite_link(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "export_chat_invite_link",
        chat_id=input_data["chat_id"],
    )
...
@action(
    ...
    input_schema={
        ...
        "expire_date": {"type": "integer", "description": "Unix timestamp expire.", "example": 1735689600},
        "member_limit": {"type": "integer", "description": "Max members 1-99999.", "example": 10},
        "creates_join_request": {"type": "boolean", "description": "Require admin approval.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def create_telegram_chat_invite_link(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "create_chat_invite_link",
        chat_id=input_data["chat_id"],
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "invite_link": {"type": "string", "description": "Invite link to edit.", "example": "https://t.me/+abc"},
        "name": {"type": "string", "description": "Name.", "example": "VIP-renamed"},
        "expire_date": {"type": "integer", "description": "Unix timestamp.", "example": 1735689600},
        "member_limit": {"type": "integer", "description": "Max members.", "example": 20},
        "creates_join_request": {"type": "boolean", "description": "Approval flow.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def edit_telegram_chat_invite_link(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "edit_chat_invite_link",
        chat_id=input_data["chat_id"],
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": "123"},
        "invite_link": {"type": "string", "description": "Invite link.", "example": "https://t.me/+abc"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def revoke_telegram_chat_invite_link(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "revoke_chat_invite_link",
        chat_id=input_data["chat_id"],
        invite_link=input_data["invite_link"],
    )
...
async def decline_telegram_chat_join_request(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "decline_chat_join_request",
        chat_id=input_data["chat_id"],
        user_id=input_data["user_id"],
    )
...
@action(
    ...
    input_schema={
        "commands": {"type": "array", "description": "List of {command, description} objects.", "example": [{"command": "start", "description": "Start the bot"}]},
        "scope": {"type": "object", "description": "BotCommandScope.", "example": {"type": "default"}},
        "language_code": {"type": "string", "description": "IETF tag.", "example": "en"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["telegram_bot_config"],
    input_schema={
        "description": {"type": "string", "description": "0-512 chars.", "example": "My great bot"},
        "language_code": {"type": "string", "description": "IETF tag.", "example": "en"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
async def get_telegram_my_description(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "get_my_description",
        language_code=input_data.get("language_code"),
    )
...
@action(
    ...
    action_sets=["telegram_bot_config"],
    input_schema={
        "short_description": {"type": "string", "description": "0-120 chars.", "example": "Helpful AI"},
        "language_code": {"type": "string", "description": "IETF tag.", "example": "en"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["telegram_bot_config"],
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID (omit for default).", "example": "123"},
        "menu_button": {"type": "object", "description": "MenuButton object.", "example": {"type": "commands"}},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
async def get_telegram_chat_menu_button(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "get_chat_menu_button",
        chat_id=input_data.get("chat_id"),
    )
...
@action(
    ...
    action_sets=["telegram_bot_config"],
    input_schema={
        "rights": {"type": "object", "description": "ChatAdministratorRights object.", "example": {"is_anonymous": False, "can_manage_chat": True}},
        "for_channels": {"type": "boolean", "description": "True for channels, false/omit for groups.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def set_telegram_my_default_administrator_rights(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "set_my_default_administrator_rights",
...
@action(
    ...
    action_sets=["telegram_bot_config"],
    input_schema={
        "for_channels": {"type": "boolean", "description": "True for channels.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def get_telegram_my_default_administrator_rights(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "telegram_bot", "get_my_default_administrator_rights",
        for_channels=input_data.get("for_channels"),
    )
...
@action(
    ...
    input_schema={
        "callback_query_id": {"type": "string", "description": "Callback query ID.", "example": "abc123"},
        "text": {"type": "string", "description": "Notification text (0-200 chars).", "example": "Got it"},
        "show_alert": {"type": "boolean", "description": "Show as alert dialog.", "example": False},
        "url": {"type": "string", "description": "Open this URL.", "example": "https://example.com"},
        "cache_time": {"type": "integer", "description": "Cache seconds.", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "url": {"type": "string", "description": "HTTPS URL.", "example": "https://example.com/tg-webhook"},
        "secret_token": {"type": "string", "description": "Header secret 1-256 chars.", "example": "topsecret"},
        "max_connections": {"type": "integer", "description": "Max concurrent updates 1-100.", "example": 40},
        "allowed_updates": {"type": "array", "description": "List of update types to receive.", "example": ["message", "callback_query"]},
        "drop_pending_updates": {"type": "boolean", "description": "Drop pending updates.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["telegram_messages", "telegram"],
    input_schema={
        "limit": {"type": "integer", "description": "Max number of updates.", "example": 10},
