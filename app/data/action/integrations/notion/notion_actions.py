...
@action(
    ...
    input_schema={
        "page_id": {"type": "string", "description": "Page ID.", "example": ""},
        "property_id": {"type": "string", "description": "Property ID (from page schema).", "example": ""},
        "page_size": {"type": "integer", "description": "Pagination size.", "example": 100},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["notion_databases", "notion"],
    input_schema={
        "parent_page_id": {"type": "string", "description": "Parent page ID.", "example": ""},
        "title": {"type": "array", "description": "Title rich_text array.", "example": [{"text": {"content": "Tasks"}}]},
        "description": {"type": "array", "description": "Description rich_text array (optional).", "example": []},
        "properties": {"type": "object", "description": "Property schema (column definitions). Required.", "example": {"Name": {"title": {}}}},
        "is_inline": {"type": "boolean", "description": "Render inline.", "example": False},
        "icon": {"type": "object", "description": "Icon (optional). e.g. {'type':'emoji','emoji':'📋'}.", "example": {}},
...
@action(
    ...
    input_schema={
        ...
        "title": {"type": "array", "description": "New title rich_text (optional).", "example": []},
        "description": {"type": "array", "description": "New description rich_text (optional).", "example": []},
        "properties": {"type": "object", "description": "Property updates (rename / change type / remove with null) (optional).", "example": {}},
        "is_inline": {"type": "boolean", "description": "Set inline (optional).", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
def archive_notion_database(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client_sync
    return run_client_sync("notion", "archive_database", database_id=input_data["database_id"])
...
def restore_notion_database(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client_sync
    return run_client_sync("notion", "restore_database", database_id=input_data["database_id"])
...
@action(
    ...
    input_schema={
        "page_id": {"type": "string", "description": "Page ID (or block ID for nested children).", "example": "abc123"},
    },
...
@action(
    ...
    action_sets=["notion_blocks", "notion"],
    input_schema={
        "page_id": {"type": "string", "description": "Page ID (or block ID).", "example": "abc123"},
...
@action(
    ...
    input_schema={
        "block_id": {"type": "string", "description": "Block ID.", "example": ""},
        "block_update": {"type": "object", "description": "Per-block-type update object.", "example": {"paragraph": {"rich_text": [{"text": {"content": "Updated"}}]}}},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "block_id": {"type": "string", "description": "Block or page ID.", "example": ""},
        "page_size": {"type": "integer", "description": "Max results.", "example": 100},
        "start_cursor": {"type": "string", "description": "Pagination cursor (optional).", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["notion_comments", "notion"],
    input_schema={
        "rich_text": {"type": "array", "description": "Comment content as rich_text array.", "example": [{"text": {"content": "Looks good!"}}]},
        "parent_page_id": {"type": "string", "description": "Page ID for a new top-level discussion (optional).", "example": ""},
        "parent_block_id": {"type": "string", "description": "Block ID for a new top-level discussion (optional).", "example": ""},
        "discussion_id": {"type": "string", "description": "Discussion ID to reply to (optional).", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "mode": {"type": "string", "description": "single_part | multi_part | external_url.", "example": "single_part"},
        "filename": {"type": "string", "description": "Required for multi_part.", "example": ""},
        "content_type": {"type": "string", "description": "MIME type (recommended).", "example": ""},
        "number_of_parts": {"type": "integer", "description": "Required for multi_part.", "example": 0},
        "external_url": {"type": "string", "description": "Required for external_url mode.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["notion_files"],
    input_schema={
        "file_upload_id": {"type": "string", "description": "ID from create_notion_file_upload.", "example": ""},
        "file_path": {"type": "string", "description": "Absolute path to local file (or one part for multi_part).", "example": ""},
        "part_number": {"type": "integer", "description": "1..1000, only for multi_part.", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["notion_files"],
    input_schema={
        "file_upload_id": {"type": "string", "description": "File upload ID.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["notion_files"],
    input_schema={
        "status": {"type": "string", "description": "Filter (optional).", "example": ""},
        "page_size": {"type": "integer", "description": "Max results.", "example": 100},
        "start_cursor": {"type": "string", "description": "Pagination cursor (optional).", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
