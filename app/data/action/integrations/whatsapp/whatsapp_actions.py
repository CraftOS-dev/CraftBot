...
@action(
    ...
    action_sets=["whatsapp_messages", "whatsapp"],
    input_schema={
        "to": {"type": "string", "description": "Recipient phone number OR the `number` / `id` from search_whatsapp_contact.", "example": "1234567890"},
        "media_path": {"type": "string", "description": "Absolute local path to the media file.", "example": "C:/Users/me/photo.jpg"},
        "caption": {"type": "string", "description": "Optional caption.", "example": ""},
        "send_as_sticker": {"type": "boolean", "description": "Send image as sticker.", "example": False},
        "send_as_voice": {"type": "boolean", "description": "Send audio as voice note.", "example": False},
        "send_as_document": {"type": "boolean", "description": "Send as document (preserves filename).", "example": False},
        "quoted_message_id": {"type": "string", "description": "Quote-reply to this message ID (optional).", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        ...
        "description": {"type": "string", "description": "Optional label.", "example": "Meeting spot"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["whatsapp_messages", "whatsapp"],
    input_schema={
        "to": {"type": "string", "description": "Recipient (usually the chat ID where the original message is).", "example": ""},
        "text": {"type": "string", "description": "Reply text.", "example": ""},
        "quoted_message_id": {"type": "string", "description": "Message ID being quoted.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        ...
        "new_body": {"type": "string", "description": "New message text.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "message_id": {"type": "string", "description": "Message ID.", "example": ""},
        "everyone": {"type": "boolean", "description": "Delete for everyone (vs only me).", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "message_id": {"type": "string", "description": "Message ID.", "example": ""},
        "to": {"type": "string", "description": "Destination chat ID or phone number.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "message_id": {"type": "string", "description": "Message ID.", "example": ""},
        "emoji": {"type": "string", "description": "Unicode emoji ('' to remove).", "example": "👍"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "message_id": {"type": "string", "description": "Message ID.", "example": ""},
        "starred": {"type": "boolean", "description": "True=star, False=unstar.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
async def download_whatsapp_message_media(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "download_message_media",
        message_id=input_data["message_id"],
...
async def get_whatsapp_quoted_message(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "get_quoted_message",
        message_id=input_data["message_id"],
    )
...
@action(
    ...
    input_schema={
        ...
        "state": {"type": "string", "description": "typing | recording | clear.", "example": "typing"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def send_whatsapp_typing_state(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "send_typing_state",
...
@action(
    ...
    input_schema={
        "phone_number": {"type": "string", "description": "Phone number or chat ID.", "example": "1234567890"},
...
async def mark_whatsapp_chat_read(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "mark_chat_read", chat_id=input_data["chat_id"])
...
async def mark_whatsapp_chat_unread(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "mark_chat_unread", chat_id=input_data["chat_id"])
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": ""},
        "archive": {"type": "boolean", "description": "True=archive, False=unarchive.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": ""},
        "pin": {"type": "boolean", "description": "True=pin, False=unpin.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "chat_id": {"type": "string", "description": "Chat ID.", "example": ""},
        "mute": {"type": "boolean", "description": "True=mute, False=unmute.", "example": True},
        "unmute_date": {"type": "integer", "description": "Unix seconds when mute expires (optional, omit for forever).", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
async def clear_whatsapp_chat_messages(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "clear_chat_messages", chat_id=input_data["chat_id"])
...
async def delete_whatsapp_chat(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "delete_chat", chat_id=input_data["chat_id"])
...
@action(
    ...
    input_schema={
        "name": {"type": "string", "description": "Group name.", "example": "Project X"},
        "participants": {"type": "array", "description": "Phone numbers or JIDs.", "example": ["1234567890"]},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        ...
        "participants": {"type": "array", "description": "Participant JIDs.", "example": []},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def add_whatsapp_group_participants(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "group_add_participants",
...
@action(
    ...
    input_schema={
        "group_id": {"type": "string", "description": "Group ID.", "example": ""},
        "participants": {"type": "array", "description": "Participant JIDs to remove.", "example": []},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def remove_whatsapp_group_participants(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "group_remove_participants",
        group_id=input_data["group_id"],
        participants=input_data["participants"],
    )
...
async def promote_whatsapp_group_participants(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "group_promote_participants",
        group_id=input_data["group_id"],
        participants=input_data["participants"],
    )
...
async def demote_whatsapp_group_participants(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "group_demote_participants",
        group_id=input_data["group_id"],
        participants=input_data["participants"],
    )
...
async def set_whatsapp_group_subject(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "group_set_subject",
        group_id=input_data["group_id"],
...
async def set_whatsapp_group_description(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "whatsapp_web", "group_set_description",
        group_id=input_data["group_id"],
...
async def get_whatsapp_group_info(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "group_get_info", group_id=input_data["group_id"])
...
async def leave_whatsapp_group(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "group_leave", group_id=input_data["group_id"])
...
async def get_whatsapp_group_invite_code(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "group_invite_code", group_id=input_data["group_id"])
...
async def revoke_whatsapp_group_invite(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "group_revoke_invite", group_id=input_data["group_id"])
...
@action(
    ...
    action_sets=["whatsapp_groups", "whatsapp"],
    input_schema={
        "invite_code": {"type": "string", "description": "Invite code or full URL.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def accept_whatsapp_group_invite(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "accept_group_invite", invite_code=input_data["invite_code"])
...
async def get_whatsapp_contact(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "get_contact", contact_id=input_data["contact_id"])
...
@action(
    ...
    action_sets=["whatsapp_contacts", "whatsapp"],
    input_schema={
        "my_contacts_only": {"type": "boolean", "description": "Filter to saved contacts.", "example": True},
...
async def get_whatsapp_profile_pic_url(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "get_profile_pic_url", contact_id=input_data["contact_id"])
...
@action(
    ...
    input_schema={
        "contact_id": {"type": "string", "description": "Contact JID.", "example": ""},
        "block": {"type": "boolean", "description": "True=block, False=unblock.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["whatsapp_contacts", "whatsapp"],
    input_schema={
        "number": {"type": "string", "description": "Phone number.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def check_number_on_whatsapp(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("whatsapp_web", "check_number_on_whatsapp", number=input_data["number"])
