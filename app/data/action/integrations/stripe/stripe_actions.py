...
@action(
    ...
    input_schema={
        "limit": {"type": "integer", "description": "Max results (1-100, default 10).", "example": 10},
        "starting_after": {"type": "string", "description": "Cursor — ID of the last item from the previous page.", "example": "cus_NffrFeUfNV2Hib"},
        "ending_before": {"type": "string", "description": "Cursor for backwards pagination.", "example": ""},
        "email": {"type": "string", "description": "Exact-match email filter.", "example": "jane@example.com"},
        "created_gte": {"type": "integer", "description": "Created at or after this UNIX timestamp.", "example": 1717200000},
        "created_lte": {"type": "integer", "description": "Created at or before this UNIX timestamp.", "example": 1719792000},
        "expand": {"type": "string", "description": "Comma-separated fields to expand (e.g. 'default_source,subscriptions').", "example": ""},
    },
...
@action(
    ...
    input_schema={
        ...
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "default_source,invoice_settings.default_payment_method"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "name": {"type": "string", "description": "Customer full name.", "example": "Jane Doe"},
        "phone": {"type": "string", "description": "Phone number (E.164 recommended).", "example": "+15551234567"},
        "description": {"type": "string", "description": "Internal description / note.", "example": "Imported from CSV 2026-06-14"},
        "address": {"type": "object", "description": "Billing address (line1, line2, city, state, postal_code, country).", "example": {"line1": "1 Main St", "city": "Springfield", "country": "US"}},
        "shipping": {"type": "object", "description": "Shipping object: {name, phone, address}.", "example": {"name": "Jane Doe", "address": {"line1": "1 Main St", "country": "US"}}},
        "metadata": {"type": "object", "description": "Arbitrary key/value labels.", "example": {"crm_id": "12345"}},
        "payment_method": {"type": "string", "description": "Default payment method to attach.", "example": ""},
        "invoice_settings": {"type": "object", "description": "Defaults applied to future invoices.", "example": {"default_payment_method": "pm_xxx"}},
        "tax_exempt": {"type": "string", "description": "'none' | 'exempt' | 'reverse'.", "example": "none"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key — pass the same key on a retry to dedupe.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        "customer_id": {"type": "string", "description": "Customer ID.", "example": "cus_NffrFeUfNV2Hib"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"email": "new@example.com", "metadata": {"vip": "true"}}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["stripe_customers", "stripe"],
    input_schema={
        "query": {"type": "string", "description": "Stripe query language clause. Operators: ':' (equal), '~' (contains), AND, OR.", "example": "email:'jane@example.com'"},
        "limit": {"type": "integer", "description": "Max results (1-100, default 10).", "example": 10},
        "page": {"type": "string", "description": "Pagination page token from previous response.next_page.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "customer": {"type": "string", "description": "Filter to a specific customer.", "example": "cus_NffrFeUfNV2Hib"},
        "created_gte": {"type": "integer", "description": "Created >= UNIX timestamp.", "example": 0},
        "created_lte": {"type": "integer", "description": "Created <= UNIX timestamp.", "example": 0},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "data.customer,data.latest_charge"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "payment_intent_id": {"type": "string", "description": "PaymentIntent ID.", "example": "pi_3MtwBwLkdIwHu7ix28a3tqPa"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "customer,latest_charge"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_payments", "stripe"],
    input_schema={
        "amount": {"type": "integer", "description": "Amount in smallest currency unit (cents for USD).", "example": 2000},
        "currency": {"type": "string", "description": "ISO 4217 lowercase. Defaults to integration 'default_currency'.", "example": "usd"},
        "customer": {"type": "string", "description": "Customer ID for off-session future payments.", "example": "cus_NffrFeUfNV2Hib"},
        "payment_method": {"type": "string", "description": "Existing payment method to attach.", "example": ""},
        "payment_method_types": {"type": "array", "description": "Allowed payment method types. Mutually exclusive with automatic_payment_methods.", "example": ["card"]},
        "automatic_payment_methods": {"type": "object", "description": "Enable Stripe's automatic method picker.", "example": {"enabled": True}},
        "confirm": {"type": "boolean", "description": "Confirm immediately. Requires payment_method.", "example": False},
        "capture_method": {"type": "string", "description": "'automatic' or 'manual' (capture later).", "example": "automatic"},
        "description": {"type": "string", "description": "Internal description.", "example": "Order #42"},
        "receipt_email": {"type": "string", "description": "Email to send receipt to on success.", "example": ""},
        "setup_future_usage": {"type": "string", "description": "'on_session' | 'off_session' — save method for later.", "example": ""},
        "statement_descriptor": {"type": "string", "description": "Appears on customer's bank statement.", "example": ""},
        "metadata": {"type": "object", "description": "Arbitrary key/value labels.", "example": {"order_id": "42"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_payments"],
    input_schema={
        "payment_intent_id": {"type": "string", "description": "PaymentIntent ID.", "example": "pi_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"amount": 3000, "metadata": {"updated_by": "agent"}}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "payment_intent_id": {"type": "string", "description": "PaymentIntent ID.", "example": "pi_…"},
        "payment_method": {"type": "string", "description": "Payment method to use.", "example": "pm_…"},
        "return_url": {"type": "string", "description": "URL to redirect to after authentication.", "example": "https://example.com/return"},
        "off_session": {"type": "boolean", "description": "True for charging a saved method without customer present.", "example": True},
        "setup_future_usage": {"type": "string", "description": "'on_session' | 'off_session'.", "example": ""},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "payment_intent_id": {"type": "string", "description": "PaymentIntent ID.", "example": "pi_…"},
        "amount_to_capture": {"type": "integer", "description": "Partial capture amount in smallest unit. Omit to capture the full amount.", "example": 0},
        "statement_descriptor": {"type": "string", "description": "Override statement descriptor for this capture.", "example": ""},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "payment_intent_id": {"type": "string", "description": "PaymentIntent ID.", "example": "pi_…"},
        "cancellation_reason": {"type": "string", "description": "'duplicate' | 'fraudulent' | 'requested_by_customer' | 'abandoned'.", "example": "requested_by_customer"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_payments"],
    input_schema={
        "query": {"type": "string", "description": "Stripe query clause.", "example": "status:'succeeded' AND amount>1000"},
        "limit": {"type": "integer", "description": "Max results (1-100).", "example": 10},
        "page": {"type": "string", "description": "Pagination page token.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "customer": {"type": "string", "description": "Filter to a specific customer.", "example": ""},
        "payment_intent": {"type": "string", "description": "Filter to a specific PaymentIntent.", "example": ""},
        "transfer_group": {"type": "string", "description": "Filter to a transfer_group label.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_payments"],
    input_schema={
        "charge_id": {"type": "string", "description": "Charge ID.", "example": "ch_3MtwBwLkdIwHu7ix28a3tqPa"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "customer,payment_intent"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_payments", "stripe"],
    input_schema={
        "payment_intent": {"type": "string", "description": "PaymentIntent ID to refund. Mutually exclusive with 'charge'.", "example": "pi_…"},
        "charge": {"type": "string", "description": "Charge ID to refund. Mutually exclusive with 'payment_intent'.", "example": ""},
        "amount": {"type": "integer", "description": "Partial refund amount in smallest currency unit. Omit for full refund.", "example": 0},
        "reason": {"type": "string", "description": "'duplicate' | 'fraudulent' | 'requested_by_customer'.", "example": "requested_by_customer"},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {"ticket_id": "T-42"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_payments"],
    input_schema={
        "refund_id": {"type": "string", "description": "Refund ID.", "example": "re_3MtwBwLkdIwHu7ix28a3tqPa"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "payment_intent": {"type": "string", "description": "Filter to a specific PaymentIntent.", "example": ""},
        "charge": {"type": "string", "description": "Filter to a specific Charge.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "customer": {"type": "string", "description": "Filter to a customer's attached methods.", "example": "cus_NffrFeUfNV2Hib"},
        "type": {"type": "string", "description": "Payment method type ('card', 'us_bank_account', 'sepa_debit', …). Default 'card'.", "example": "card"},
        "limit": {"type": "integer", "description": "Max results (1-100).", "example": 10},
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
...
@action(
    ...
    action_sets=["stripe_payment_methods"],
    input_schema={
        "payment_method_id": {"type": "string", "description": "PaymentMethod ID.", "example": "pm_…"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "payment_method_id": {"type": "string", "description": "PaymentMethod ID.", "example": "pm_…"},
        "customer": {"type": "string", "description": "Customer to attach to.", "example": "cus_NffrFeUfNV2Hib"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "payment_method_id": {"type": "string", "description": "PaymentMethod ID.", "example": "pm_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"billing_details": {"email": "new@example.com"}, "metadata": {"label": "primary"}}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "active": {"type": "boolean", "description": "Only active or only inactive.", "example": True},
        "ids": {"type": "array", "description": "Explicit list of product IDs to fetch.", "example": ["prod_…"]},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "data.default_price"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "product_id": {"type": "string", "description": "Product ID.", "example": "prod_NWjs8kKbJWmuuc"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "default_price"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_products", "stripe"],
    input_schema={
        "name": {"type": "string", "description": "Product name (required).", "example": "Standard Plan"},
        "description": {"type": "string", "description": "Marketing description.", "example": "Up to 5 seats"},
        "active": {"type": "boolean", "description": "Whether the product is active. Default True.", "example": True},
        "images": {"type": "array", "description": "Image URLs.", "example": ["https://example.com/img.png"]},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {"sku": "SP-001"}},
        "default_price_data": {"type": "object", "description": "Inline price to create alongside the product.", "example": {"currency": "usd", "unit_amount": 1000, "recurring": {"interval": "month"}}},
        "shippable": {"type": "boolean", "description": "Whether the product is shippable.", "example": False},
        "statement_descriptor": {"type": "string", "description": "Appears on bank statements.", "example": ""},
        "tax_code": {"type": "string", "description": "Stripe Tax code (txcd_…).", "example": ""},
        "unit_label": {"type": "string", "description": "Singular noun for a unit (e.g. 'seat').", "example": "seat"},
...
@action(
    ...
    action_sets=["stripe_products"],
    input_schema={
        "product_id": {"type": "string", "description": "Product ID.", "example": "prod_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"name": "Pro Plan", "active": True}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "active": {"type": "boolean", "description": "Only active or only inactive.", "example": True},
        "product": {"type": "string", "description": "Filter to a specific product.", "example": "prod_…"},
        "currency": {"type": "string", "description": "ISO 4217 lowercase filter.", "example": "usd"},
        "type": {"type": "string", "description": "'one_time' | 'recurring'.", "example": "recurring"},
        "recurring_interval": {"type": "string", "description": "'day' | 'week' | 'month' | 'year'.", "example": "month"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "data.product"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_products"],
    input_schema={
        "price_id": {"type": "string", "description": "Price ID.", "example": "price_1MoBy5LkdIwHu7ixZhnattbh"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "product"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "currency": {"type": "string", "description": "ISO 4217 lowercase. Defaults to integration default_currency.", "example": "usd"},
        "product": {"type": "string", "description": "Existing Product ID. Mutually exclusive with product_data.", "example": "prod_…"},
        "product_data": {"type": "object", "description": "Inline product to create.", "example": {"name": "New product"}},
        "unit_amount": {"type": "integer", "description": "Price in smallest currency unit.", "example": 1000},
        "unit_amount_decimal": {"type": "string", "description": "Decimal price (e.g. '1000.5'). Use when sub-cent precision is needed.", "example": ""},
        "active": {"type": "boolean", "description": "Whether the price is active.", "example": True},
        "nickname": {"type": "string", "description": "Internal label.", "example": "Monthly Standard"},
        "recurring": {"type": "object", "description": "Recurring config: {interval: 'month', interval_count: 1, usage_type: 'licensed'}.", "example": {"interval": "month"}},
        "tax_behavior": {"type": "string", "description": "'inclusive' | 'exclusive' | 'unspecified'.", "example": "unspecified"},
        "billing_scheme": {"type": "string", "description": "'per_unit' | 'tiered'.", "example": "per_unit"},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {"plan_id": "monthly_v2"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_products"],
    input_schema={
        "price_id": {"type": "string", "description": "Price ID.", "example": "price_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"active": False, "nickname": "Legacy"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "customer": {"type": "string", "description": "Filter to a specific customer.", "example": ""},
        "subscription": {"type": "string", "description": "Filter to a specific subscription.", "example": ""},
        "status": {"type": "string", "description": "'draft' | 'open' | 'paid' | 'uncollectible' | 'void'.", "example": "open"},
        "collection_method": {"type": "string", "description": "'charge_automatically' | 'send_invoice'.", "example": ""},
        "created_gte": {"type": "integer", "description": "Created >= UNIX timestamp.", "example": 0},
        "created_lte": {"type": "integer", "description": "Created <= UNIX timestamp.", "example": 0},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "data.customer,data.subscription"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "invoice_id": {"type": "string", "description": "Invoice ID.", "example": "in_1MtwBwLkdIwHu7ix28a3tqPa"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "customer,subscription,charge"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_invoices", "stripe"],
    input_schema={
        "customer": {"type": "string", "description": "Customer ID.", "example": "cus_NffrFeUfNV2Hib"},
        "auto_advance": {"type": "boolean", "description": "Stripe finalizes + collects automatically.", "example": False},
        "collection_method": {"type": "string", "description": "'charge_automatically' | 'send_invoice'.", "example": "send_invoice"},
        "days_until_due": {"type": "integer", "description": "Required if collection_method='send_invoice'.", "example": 30},
        "due_date": {"type": "integer", "description": "Explicit due date (UNIX timestamp). Alternative to days_until_due.", "example": 0},
        "description": {"type": "string", "description": "Invoice description.", "example": "June consulting"},
        "footer": {"type": "string", "description": "Footer on the rendered invoice.", "example": ""},
        "default_payment_method": {"type": "string", "description": "PaymentMethod to use for charge_automatically.", "example": ""},
        "statement_descriptor": {"type": "string", "description": "Appears on bank statement.", "example": ""},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {"project_id": "P-42"}},
        "pending_invoice_items_behavior": {"type": "string", "description": "'include' | 'exclude' pending invoice items.", "example": "include"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
async def create_stripe_invoice(input_data: dict) -> dict:
    ...
    return await run_client(
        ...
        statement_descriptor=input_data.get("statement_descriptor") or None,
        metadata=input_data.get("metadata") or None,
        pending_invoice_items_behavior=input_data.get("pending_invoice_items_behavior") or None,
        idempotency_key=input_data.get("idempotency_key") or None,
    )
...
@action(
    ...
    action_sets=["stripe_invoices"],
    input_schema={
        "invoice_id": {"type": "string", "description": "Invoice ID.", "example": "in_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"description": "Updated", "metadata": {"updated_by": "agent"}}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_invoices", "stripe"],
    input_schema={
        "invoice_id": {"type": "string", "description": "Invoice ID (must be draft).", "example": "in_…"},
        "auto_advance": {"type": "boolean", "description": "After finalize, let Stripe handle collection automatically.", "example": True},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_invoices", "stripe"],
    input_schema={
        "invoice_id": {"type": "string", "description": "Invoice ID (must be open / finalized).", "example": "in_…"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_invoices"],
    input_schema={
        "invoice_id": {"type": "string", "description": "Invoice ID (must be open).", "example": "in_…"},
        "payment_method": {"type": "string", "description": "Override default payment method.", "example": ""},
        "off_session": {"type": "boolean", "description": "True for charging a saved method without customer present.", "example": True},
        "paid_out_of_band": {"type": "boolean", "description": "Mark as paid without actually charging (offline payment).", "example": False},
        "forgive": {"type": "boolean", "description": "Forgive any remaining balance after partial payment.", "example": False},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_invoices"],
    input_schema={
        "customer": {"type": "string", "description": "Customer ID.", "example": "cus_…"},
        "subscription": {"type": "string", "description": "Subscription ID (alternative to customer).", "example": ""},
        "subscription_items": {"type": "array", "description": "Hypothetical items to simulate a change.", "example": []},
        "coupon": {"type": "string", "description": "Coupon to apply to the simulated invoice.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "customer": {"type": "string", "description": "Filter to a specific customer.", "example": ""},
        "invoice": {"type": "string", "description": "Filter to a specific invoice.", "example": ""},
        "pending": {"type": "boolean", "description": "Only items not yet on an invoice.", "example": True},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "customer": {"type": "string", "description": "Customer ID.", "example": "cus_…"},
        "invoice": {"type": "string", "description": "Draft invoice to attach to. Omit for pending.", "example": ""},
        "amount": {"type": "integer", "description": "Amount in smallest currency unit. Mutually exclusive with price.", "example": 2500},
        "currency": {"type": "string", "description": "ISO 4217 lowercase. Required when 'amount' is set.", "example": "usd"},
        "price": {"type": "string", "description": "Price ID. Mutually exclusive with amount.", "example": ""},
        "quantity": {"type": "integer", "description": "Quantity (default 1).", "example": 1},
        "description": {"type": "string", "description": "Line item description.", "example": "Consulting hour"},
        "discountable": {"type": "boolean", "description": "Whether discounts apply.", "example": True},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "tax_rates": {"type": "array", "description": "Stripe tax rate IDs to apply.", "example": []},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_invoices"],
    input_schema={
        "invoice_item_id": {"type": "string", "description": "Invoice Item ID.", "example": "ii_…"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "customer": {"type": "string", "description": "Filter to a customer.", "example": ""},
        "price": {"type": "string", "description": "Filter to subscriptions containing a price.", "example": ""},
        "status": {"type": "string", "description": "'active' | 'past_due' | 'unpaid' | 'canceled' | 'incomplete' | 'incomplete_expired' | 'trialing' | 'paused' | 'all'.", "example": "active"},
        "collection_method": {"type": "string", "description": "'charge_automatically' | 'send_invoice'.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "data.customer,data.default_payment_method"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "subscription_id": {"type": "string", "description": "Subscription ID.", "example": "sub_1MowQVLkdIwHu7ixeRlqHVzs"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "customer,latest_invoice,default_payment_method"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "customer": {"type": "string", "description": "Customer ID.", "example": "cus_NffrFeUfNV2Hib"},
        "items": {"type": "array", "description": "Line items: [{price, quantity}].", "example": [{"price": "price_xxx", "quantity": 1}]},
        "cancel_at_period_end": {"type": "boolean", "description": "Schedule cancellation at end of current period.", "example": False},
        "collection_method": {"type": "string", "description": "'charge_automatically' | 'send_invoice'.", "example": "charge_automatically"},
        "days_until_due": {"type": "integer", "description": "Required if collection_method='send_invoice'.", "example": 0},
        "default_payment_method": {"type": "string", "description": "PaymentMethod ID.", "example": ""},
        "default_tax_rates": {"type": "array", "description": "Tax rate IDs applied to all items.", "example": []},
        "coupon": {"type": "string", "description": "Coupon code to apply.", "example": ""},
        "promotion_code": {"type": "string", "description": "Promotion code ID.", "example": ""},
        "trial_period_days": {"type": "integer", "description": "Trial length in days.", "example": 0},
        "trial_end": {"type": "integer", "description": "Explicit trial end (UNIX timestamp).", "example": 0},
        "payment_behavior": {"type": "string", "description": "'default_incomplete' | 'allow_incomplete' | 'error_if_incomplete' | 'pending_if_incomplete'.", "example": "default_incomplete"},
        "proration_behavior": {"type": "string", "description": "'create_prorations' | 'none' | 'always_invoice'.", "example": ""},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    action_sets=["stripe_subscriptions"],
    input_schema={
        "subscription_id": {"type": "string", "description": "Subscription ID.", "example": "sub_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"cancel_at_period_end": True}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "subscription_id": {"type": "string", "description": "Subscription ID.", "example": "sub_…"},
        "invoice_now": {"type": "boolean", "description": "Invoice unbilled metered usage immediately.", "example": False},
        "prorate": {"type": "boolean", "description": "Generate proration credits.", "example": True},
        "cancellation_details": {"type": "object", "description": "{comment, feedback}.", "example": {"feedback": "too_expensive"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "subscription_id": {"type": "string", "description": "Subscription ID.", "example": "sub_…"},
        "billing_cycle_anchor": {"type": "string", "description": "'now' | 'unchanged'.", "example": "now"},
        "proration_behavior": {"type": "string", "description": "'create_prorations' | 'none' | 'always_invoice'.", "example": "create_prorations"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "customer": {"type": "string", "description": "Filter to a customer.", "example": ""},
        "payment_intent": {"type": "string", "description": "Filter to a PaymentIntent.", "example": ""},
        "subscription": {"type": "string", "description": "Filter to a subscription.", "example": ""},
        "status": {"type": "string", "description": "'open' | 'complete' | 'expired'.", "example": "complete"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_checkout"],
    input_schema={
        "session_id": {"type": "string", "description": "Checkout Session ID.", "example": "cs_test_…"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "line_items,customer"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "mode": {"type": "string", "description": "'payment' | 'subscription' | 'setup'.", "example": "payment"},
        "line_items": {"type": "array", "description": "Line items: [{price: 'price_xxx', quantity: 1}] or [{price_data: {…}, quantity: 1}].", "example": [{"price": "price_xxx", "quantity": 1}]},
        "success_url": {"type": "string", "description": "Redirect on success. Use {CHECKOUT_SESSION_ID} placeholder for the session ID.", "example": "https://example.com/success?session_id={CHECKOUT_SESSION_ID}"},
        "cancel_url": {"type": "string", "description": "Redirect on cancel.", "example": "https://example.com/cancel"},
        "ui_mode": {"type": "string", "description": "'hosted' (default) | 'embedded'.", "example": "hosted"},
        "customer": {"type": "string", "description": "Existing customer to attach the session to.", "example": ""},
        "customer_email": {"type": "string", "description": "Pre-fill the customer's email.", "example": ""},
        "client_reference_id": {"type": "string", "description": "Your internal ID for reconciliation via webhook.", "example": "order_42"},
        "allow_promotion_codes": {"type": "boolean", "description": "Show a 'have a promo code' field.", "example": True},
        "automatic_tax": {"type": "object", "description": "{enabled: true} to compute Stripe Tax.", "example": {"enabled": True}},
        "billing_address_collection": {"type": "string", "description": "'auto' | 'required'.", "example": "auto"},
        "payment_method_types": {"type": "array", "description": "Allowed payment method types.", "example": ["card"]},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
async def list_stripe_checkout_line_items(input_data: dict) -> dict:
    ...
    return await run_client(
        "stripe", "list_checkout_line_items",
        session_id=input_data["session_id"],
        limit=input_data.get("limit", 10),
        starting_after=input_data.get("starting_after") or None,
        ending_before=input_data.get("ending_before") or None,
...
@action(
    ...
    action_sets=["stripe_payment_links"],
    input_schema={
        "payment_link_id": {"type": "string", "description": "Payment Link ID.", "example": "pl_1MoBy5LkdIwHu7ixZhnattbh"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "line_items"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "line_items": {"type": "array", "description": "Line items: [{price: 'price_xxx', quantity: 1}].", "example": [{"price": "price_xxx", "quantity": 1}]},
        "after_completion": {"type": "object", "description": "What happens after success: {type: 'redirect', redirect: {url: '…'}} or {type: 'hosted_confirmation', hosted_confirmation: {custom_message: '…'}}.", "example": {"type": "hosted_confirmation"}},
        "allow_promotion_codes": {"type": "boolean", "description": "Show a 'have a promo code' field.", "example": True},
        "automatic_tax": {"type": "object", "description": "{enabled: true}.", "example": {"enabled": True}},
        "billing_address_collection": {"type": "string", "description": "'auto' | 'required'.", "example": "auto"},
        "customer_creation": {"type": "string", "description": "'always' | 'if_required'.", "example": "always"},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "payment_method_types": {"type": "array", "description": "Allowed payment method types.", "example": []},
        "shipping_address_collection": {"type": "object", "description": "{allowed_countries: [...]}.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
async def create_stripe_payment_link(input_data: dict) -> dict:
    ...
    return await run_client(
        ...
        metadata=input_data.get("metadata") or None,
        payment_method_types=input_data.get("payment_method_types") or None,
        shipping_address_collection=input_data.get("shipping_address_collection") or None,
        idempotency_key=input_data.get("idempotency_key") or None,
    )
...
@action(
    ...
    action_sets=["stripe_payment_links"],
    input_schema={
        "payment_link_id": {"type": "string", "description": "Payment Link ID.", "example": "pl_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"active": False}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        "customer": {"type": "string", "description": "Customer ID.", "example": "cus_…"},
        "return_url": {"type": "string", "description": "Where the customer returns when they're done.", "example": "https://example.com/account"},
        "configuration": {"type": "string", "description": "Specific portal configuration ID.", "example": ""},
        "locale": {"type": "string", "description": "BCP-47 locale (e.g. 'en', 'de-DE').", "example": ""},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_promotions"],
    input_schema={
        "coupon_id": {"type": "string", "description": "Coupon ID (user-chosen, e.g. 'SUMMER25').", "example": "SUMMER25"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_promotions"],
    input_schema={
        "id": {"type": "string", "description": "Optional user-chosen ID (e.g. 'SUMMER25'). Auto-generated if omitted.", "example": "SUMMER25"},
        "name": {"type": "string", "description": "Customer-facing label.", "example": "Summer 25%"},
        "duration": {"type": "string", "description": "'once' | 'repeating' | 'forever'.", "example": "once"},
        "amount_off": {"type": "integer", "description": "Amount off in smallest currency unit. Mutually exclusive with percent_off.", "example": 0},
        "percent_off": {"type": "number", "description": "Percentage off (e.g. 25 = 25%). Mutually exclusive with amount_off.", "example": 25},
        "currency": {"type": "string", "description": "ISO 4217 lowercase. Required if amount_off is set.", "example": "usd"},
        "duration_in_months": {"type": "integer", "description": "Required if duration='repeating'.", "example": 3},
        "max_redemptions": {"type": "integer", "description": "Cap on total redemptions across all customers.", "example": 0},
        "redeem_by": {"type": "integer", "description": "UNIX timestamp after which the coupon can no longer be redeemed.", "example": 0},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    action_sets=["stripe_promotions"],
    input_schema={
        "coupon_id": {"type": "string", "description": "Coupon ID.", "example": "SUMMER25"},
        "properties": {"type": "object", "description": "Mutable properties (name, metadata).", "example": {"name": "Summer (extended)"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "active": {"type": "boolean", "description": "Only active or only inactive.", "example": True},
        "code": {"type": "string", "description": "Exact code filter.", "example": "FRIENDS50"},
        "coupon": {"type": "string", "description": "Parent coupon ID.", "example": ""},
        "customer": {"type": "string", "description": "Promotion codes allowlisted to this customer.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_promotions"],
    input_schema={
        "coupon": {"type": "string", "description": "Parent Coupon ID.", "example": "SUMMER25"},
        "code": {"type": "string", "description": "Code string. Auto-generated if omitted.", "example": "FRIENDS50"},
        "customer": {"type": "string", "description": "Restrict to a specific customer.", "example": ""},
        "active": {"type": "boolean", "description": "Whether the code is redeemable.", "example": True},
        "expires_at": {"type": "integer", "description": "UNIX timestamp expiry.", "example": 0},
        "max_redemptions": {"type": "integer", "description": "Total redemption cap.", "example": 0},
        "restrictions": {"type": "object", "description": "{first_time_transaction: bool, minimum_amount: int, minimum_amount_currency: str}.", "example": {"first_time_transaction": True}},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    action_sets=["stripe_promotions"],
    input_schema={
        "promotion_code_id": {"type": "string", "description": "Promotion Code ID.", "example": "promo_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"active": False}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    action_sets=["stripe_disputes"],
    input_schema={
        "dispute_id": {"type": "string", "description": "Dispute ID.", "example": "di_…"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "charge,payment_intent"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "dispute_id": {"type": "string", "description": "Dispute ID.", "example": "di_…"},
        "evidence": {"type": "object", "description": "Evidence fields (see Stripe docs for the full schema — receipt, shipping_documentation, customer_email_address, etc.).", "example": {"customer_email_address": "jane@example.com", "uncategorized_text": "Customer was refunded immediately."}},
        "submit": {"type": "boolean", "description": "True submits to card network. Omit/False saves as draft.", "example": False},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "status": {"type": "string", "description": "'pending' | 'in_transit' | 'paid' | 'failed' | 'canceled'.", "example": "paid"},
        "destination": {"type": "string", "description": "Bank account or card ID.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "destination,failure_balance_transaction"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_payouts"],
    input_schema={
        "amount": {"type": "integer", "description": "Amount in smallest currency unit.", "example": 10000},
        "currency": {"type": "string", "description": "ISO 4217 lowercase. Defaults to integration default_currency.", "example": "usd"},
        "description": {"type": "string", "description": "Internal description.", "example": "Weekly payout"},
        "statement_descriptor": {"type": "string", "description": "Appears on bank statement.", "example": ""},
        "method": {"type": "string", "description": "'standard' | 'instant'.", "example": "standard"},
        "source_type": {"type": "string", "description": "'bank_account' | 'card'.", "example": "bank_account"},
        "destination": {"type": "string", "description": "Specific bank account or card ID. Omit to use the default.", "example": ""},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "type": {"type": "string", "description": "'charge' | 'refund' | 'adjustment' | 'application_fee' | 'payout' | 'transfer' | 'stripe_fee' | etc.", "example": "charge"},
        "currency": {"type": "string", "description": "ISO 4217 lowercase filter.", "example": ""},
        "source": {"type": "string", "description": "Filter to a specific source ID (charge, refund, etc.).", "example": ""},
        "payout": {"type": "string", "description": "Filter to transactions in a specific payout.", "example": ""},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "customer": {"type": "string", "description": "Filter to a customer.", "example": ""},
        "status": {"type": "string", "description": "'draft' | 'open' | 'accepted' | 'canceled'.", "example": "open"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": "line_items,customer,invoice"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "customer": {"type": "string", "description": "Customer ID.", "example": "cus_…"},
        "line_items": {"type": "array", "description": "Line items: [{price: 'price_xxx', quantity: 1}].", "example": [{"price": "price_xxx", "quantity": 1}]},
        "description": {"type": "string", "description": "Internal description.", "example": ""},
        "footer": {"type": "string", "description": "Footer on the rendered quote.", "example": ""},
        "header": {"type": "string", "description": "Header on the rendered quote.", "example": ""},
        "expires_at": {"type": "integer", "description": "UNIX timestamp expiry.", "example": 0},
        "collection_method": {"type": "string", "description": "'charge_automatically' | 'send_invoice'.", "example": ""},
        "default_tax_rates": {"type": "array", "description": "Tax rate IDs applied to all items.", "example": []},
        "subscription_data": {"type": "object", "description": "Defaults applied to the subscription created on accept.", "example": {}},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        "quote_id": {"type": "string", "description": "Quote ID.", "example": "qt_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"description": "Updated"}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_quotes"],
    input_schema={
        "quote_id": {"type": "string", "description": "Quote ID (must be draft).", "example": "qt_…"},
        "expires_at": {"type": "integer", "description": "Override expiry at finalize time.", "example": 0},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    action_sets=["stripe_quotes"],
    input_schema={
        "quote_id": {"type": "string", "description": "Quote ID (must be open).", "example": "qt_…"},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "type": {"type": "string", "description": "Single event type filter.", "example": "invoice.paid"},
        "types": {"type": "array", "description": "List of event types.", "example": ["invoice.paid", "invoice.finalized"]},
        "delivery_success": {"type": "boolean", "description": "Only events delivered (or not delivered) successfully to a webhook.", "example": True},
        "created_gte": {"type": "integer", "description": "Created >= UNIX timestamp.", "example": 0},
        "created_lte": {"type": "integer", "description": "Created <= UNIX timestamp.", "example": 0},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
...
@action(
    ...
    action_sets=["stripe_webhooks"],
    input_schema={
        "endpoint_id": {"type": "string", "description": "Webhook Endpoint ID.", "example": "we_…"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["stripe_webhooks"],
    input_schema={
        "url": {"type": "string", "description": "HTTPS URL Stripe will POST events to.", "example": "https://example.com/stripe/webhook"},
        "enabled_events": {"type": "array", "description": "Event types to subscribe to, or ['*'] for all.", "example": ["invoice.paid", "customer.created"]},
        "description": {"type": "string", "description": "Internal description.", "example": ""},
        "connect": {"type": "boolean", "description": "True for Connect events from connected accounts.", "example": False},
        "api_version": {"type": "string", "description": "Pin the event payload version.", "example": ""},
        "metadata": {"type": "object", "description": "Arbitrary labels.", "example": {}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        "endpoint_id": {"type": "string", "description": "Webhook Endpoint ID.", "example": "we_…"},
        "properties": {"type": "object", "description": "Properties to update.", "example": {"enabled_events": ["invoice.paid"], "disabled": False}},
        "idempotency_key": {"type": "string", "description": "Optional idempotency key.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
...
async def update_stripe_webhook_endpoint(input_data: dict) -> dict:
    ...
    return await run_client(
        "stripe", "update_webhook_endpoint",
        endpoint_id=input_data["endpoint_id"],
        properties=input_data.get("properties") or {},
        idempotency_key=input_data.get("idempotency_key") or None,
    )
...
@action(
    ...
    input_schema={
        "file_path": {"type": "string", "description": "Absolute path to a local file.", "example": "/tmp/receipt.png"},
        "purpose": {"type": "string", "description": "'dispute_evidence' | 'identity_document' | 'business_logo' | 'business_icon' | 'tax_document_user_upload' | 'finance_report_run' | 'pci_document' | 'additional_verification' | 'customer_signature'.", "example": "dispute_evidence"},
        "link_create": {"type": "boolean", "description": "Create a public file link alongside the upload.", "example": False},
        "link_expires_at": {"type": "integer", "description": "UNIX timestamp link expiry.", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        ...
        "starting_after": {"type": "string", "description": "Cursor.", "example": ""},
        "ending_before": {"type": "string", "description": "Cursor.", "example": ""},
        "purpose": {"type": "string", "description": "Filter by file purpose.", "example": "dispute_evidence"},
        "expand": {"type": "string", "description": "Comma-separated fields to expand.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
