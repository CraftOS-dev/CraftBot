...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Source document ID.", "example": "1abcDEF..."},
        "new_title": {"type": "string", "description": "Title for the copy.", "example": "Meeting Notes (copy)"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def copy_google_doc(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client_sync
    return run_client_sync(
        "google_docs", "copy_document",
        unwrap_envelope=True, fail_message="Failed to copy document.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Source document ID.", "example": "1abcDEF..."},
        "mime_type": {"type": "string", "description": "Export MIME type. application/pdf | application/vnd.openxmlformats-officedocument.wordprocessingml.document | application/vnd.oasis.opendocument.text | text/plain | text/html.", "example": "application/pdf"},
        "dest_path": {"type": "string", "description": "Local file path to write to.", "example": "/tmp/doc.pdf"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
def export_google_doc(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client_sync
    return run_client_sync(
        "google_docs", "export_document",
        unwrap_envelope=True, fail_message="Failed to export document.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        ...
        "index": {"type": "integer", "description": "Position (UTF-16 index). Index 1 = start of body.", "example": 1},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def insert_text_into_google_doc(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Text inserted.", fail_message="Failed to insert text.",
        document_id=input_data["document_id"],
        text=input_data["text"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "start_index": {"type": "integer", "description": "Start UTF-16 index (inclusive).", "example": 10},
        "end_index": {"type": "integer", "description": "End UTF-16 index (exclusive).", "example": 30},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def delete_google_doc_range(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Range deleted.", fail_message="Failed to delete range.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "start_index": {"type": "integer", "description": "Start UTF-16 index.", "example": 10},
        "end_index": {"type": "integer", "description": "End UTF-16 index (exclusive).", "example": 30},
        "bold": {"type": "boolean", "description": "Toggle bold.", "example": True},
        "italic": {"type": "boolean", "description": "Toggle italic.", "example": False},
        "underline": {"type": "boolean", "description": "Toggle underline.", "example": False},
        "strikethrough": {"type": "boolean", "description": "Toggle strikethrough.", "example": False},
        "font_size_pt": {"type": "number", "description": "Font size in points.", "example": 14},
        "font_family": {"type": "string", "description": "Font family name.", "example": "Arial"},
        "foreground_color_hex": {"type": "string", "description": "Foreground color (#RRGGBB).", "example": "#FF0000"},
        "background_color_hex": {"type": "string", "description": "Background color (#RRGGBB).", "example": "#FFFF00"},
        "link_url": {"type": "string", "description": "Turn range into a hyperlink to this URL.", "example": "https://example.com"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def style_google_doc_text(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client_sync
    return run_client_sync(
        "google_docs", "update_text_style",
        unwrap_envelope=True, success_message="Text styled.", fail_message="Failed to style text.",
        document_id=input_data["document_id"],
        start_index=input_data["start_index"],
        end_index=input_data["end_index"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "start_index": {"type": "integer", "description": "Start UTF-16 index.", "example": 1},
        "end_index": {"type": "integer", "description": "End UTF-16 index (exclusive).", "example": 20},
        "named_style_type": {"type": "string", "description": "NORMAL_TEXT | TITLE | SUBTITLE | HEADING_1..HEADING_6.", "example": "HEADING_1"},
        "alignment": {"type": "string", "description": "START | CENTER | END | JUSTIFIED.", "example": "CENTER"},
        "line_spacing": {"type": "number", "description": "Percentage (100 = single).", "example": 150},
        "keep_with_next": {"type": "boolean", "description": "Keep with following paragraph.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def style_google_doc_paragraph(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client_sync
    return run_client_sync(
        "google_docs", "update_paragraph_style",
        unwrap_envelope=True, success_message="Paragraph styled.", fail_message="Failed to style paragraph.",
        document_id=input_data["document_id"],
        start_index=input_data["start_index"],
        end_index=input_data["end_index"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "start_index": {"type": "integer", "description": "Start UTF-16 index.", "example": 10},
        "end_index": {"type": "integer", "description": "End UTF-16 index.", "example": 60},
        "bullet_preset": {"type": "string", "description": "BULLET_DISC_CIRCLE_SQUARE | NUMBERED_DECIMAL_NESTED | BULLET_CHECKBOX | NUMBERED_DECIMAL_ALPHA_ROMAN | BULLET_ARROW_DIAMOND_DISC.", "example": "BULLET_DISC_CIRCLE_SQUARE"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def create_google_doc_bullets(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Bullets created.", fail_message="Failed to create bullets.",
        document_id=input_data["document_id"],
        start_index=input_data["start_index"],
        end_index=input_data["end_index"],
...
def delete_google_doc_bullets(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Bullets removed.", fail_message="Failed to remove bullets.",
        document_id=input_data["document_id"],
        start_index=input_data["start_index"],
        end_index=input_data["end_index"],
    )
...
@action(
    ...
    input_schema={
        ...
        "columns": {"type": "integer", "description": "Number of columns.", "example": 3},
        "index": {"type": "integer", "description": "Position to insert at.", "example": 1},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def insert_google_doc_table(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Table inserted.", fail_message="Failed to insert table.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "table_start_index": {"type": "integer", "description": "The table's start index in the document.", "example": 5},
        "row_index": {"type": "integer", "description": "Reference cell row (0-based).", "example": 0},
        "column_index": {"type": "integer", "description": "Reference cell column (0-based).", "example": 0},
        "insert_below": {"type": "boolean", "description": "True = below, False = above.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def insert_google_doc_table_row(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, fail_message="Failed to insert row.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "table_start_index": {"type": "integer", "description": "Table start index.", "example": 5},
        "row_index": {"type": "integer", "description": "Reference cell row.", "example": 0},
        "column_index": {"type": "integer", "description": "Reference cell column.", "example": 0},
        "insert_right": {"type": "boolean", "description": "True = right, False = left.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def insert_google_doc_table_column(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, fail_message="Failed to insert column.",
        document_id=input_data["document_id"],
        table_start_index=input_data["table_start_index"],
        row_index=input_data["row_index"],
        column_index=input_data["column_index"],
...
@action(
    ...
    input_schema={
        ...
        "column_index": {"type": "integer", "description": "Any column index in the row.", "example": 0},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def delete_google_doc_table_row(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, fail_message="Failed to delete row.",
        document_id=input_data["document_id"],
        table_start_index=input_data["table_start_index"],
        row_index=input_data["row_index"],
        column_index=input_data["column_index"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "table_start_index": {"type": "integer", "description": "Table start index.", "example": 5},
        "row_index": {"type": "integer", "description": "Any row index in the column.", "example": 0},
        "column_index": {"type": "integer", "description": "Column to delete.", "example": 1},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def delete_google_doc_table_column(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, fail_message="Failed to delete column.",
        document_id=input_data["document_id"],
        table_start_index=input_data["table_start_index"],
        row_index=input_data["row_index"],
        column_index=input_data["column_index"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "table_start_index": {"type": "integer", "description": "Table start index.", "example": 5},
        "row_index": {"type": "integer", "description": "Top-left cell row.", "example": 0},
        "column_index": {"type": "integer", "description": "Top-left cell column.", "example": 0},
        "row_span": {"type": "integer", "description": "Rows to span.", "example": 2},
        "column_span": {"type": "integer", "description": "Columns to span.", "example": 2},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def merge_google_doc_table_cells(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, fail_message="Failed to merge cells.",
        document_id=input_data["document_id"],
        table_start_index=input_data["table_start_index"],
        row_index=input_data["row_index"],
        column_index=input_data["column_index"],
...
@action(
    ...
    input_schema={
        ...
        "row_index": {"type": "integer", "description": "Top-left cell row.", "example": 0},
        "column_index": {"type": "integer", "description": "Top-left cell column.", "example": 0},
        "row_span": {"type": "integer", "description": "Rows in merged region.", "example": 2},
        "column_span": {"type": "integer", "description": "Columns in merged region.", "example": 2},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def unmerge_google_doc_table_cells(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, fail_message="Failed to unmerge cells.",
        document_id=input_data["document_id"],
        table_start_index=input_data["table_start_index"],
        row_index=input_data["row_index"],
        column_index=input_data["column_index"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "image_uri": {"type": "string", "description": "Publicly accessible image URL.", "example": "https://example.com/logo.png"},
        "index": {"type": "integer", "description": "Insertion index.", "example": 1},
        "width_pt": {"type": "number", "description": "Optional width in points.", "example": 200},
        "height_pt": {"type": "number", "description": "Optional height in points.", "example": 150},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def insert_google_doc_image(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Image inserted.", fail_message="Failed to insert image.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "image_object_id": {"type": "string", "description": "Inline image object ID.", "example": "kix.xxxx"},
        "image_uri": {"type": "string", "description": "New image URI.", "example": "https://example.com/new.png"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def replace_google_doc_image(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Image replaced.", fail_message="Failed to replace image.",
        document_id=input_data["document_id"],
...
def insert_google_doc_page_break(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Page break inserted.", fail_message="Failed to insert page break.",
        document_id=input_data["document_id"],
        index=input_data["index"],
    )
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "index": {"type": "integer", "description": "Insertion index.", "example": 1},
        "section_type": {"type": "string", "description": "NEXT_PAGE | CONTINUOUS.", "example": "NEXT_PAGE"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def insert_google_doc_section_break(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Section break inserted.", fail_message="Failed to insert section break.",
        document_id=input_data["document_id"],
        index=input_data["index"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "header_type": {"type": "string", "description": "DEFAULT | FIRST_PAGE_HEADER.", "example": "DEFAULT"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def create_google_doc_header(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Header created.", fail_message="Failed to create header.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "footer_type": {"type": "string", "description": "DEFAULT | FIRST_PAGE_FOOTER.", "example": "DEFAULT"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def create_google_doc_footer(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Footer created.", fail_message="Failed to create footer.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "header_id": {"type": "string", "description": "Header ID.", "example": "kix.xxxx"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def delete_google_doc_header(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Header deleted.", fail_message="Failed to delete header.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "footer_id": {"type": "string", "description": "Footer ID.", "example": "kix.xxxx"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def delete_google_doc_footer(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Footer deleted.", fail_message="Failed to delete footer.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "name": {"type": "string", "description": "Range name.", "example": "intro_section"},
        "start_index": {"type": "integer", "description": "Start UTF-16 index.", "example": 1},
        "end_index": {"type": "integer", "description": "End UTF-16 index.", "example": 50},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def create_google_doc_named_range(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Named range created.", fail_message="Failed to create named range.",
        document_id=input_data["document_id"],
...
@action(
    ...
    input_schema={
        "document_id": {"type": "string", "description": "Document ID.", "example": "1abcDEF..."},
        "name": {"type": "string", "description": "Range name to delete (one of name or id required).", "example": "intro_section"},
        "named_range_id": {"type": "string", "description": "Named range ID (alternative to name).", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
def delete_google_doc_named_range(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        unwrap_envelope=True, success_message="Named range deleted.", fail_message="Failed to delete named range.",
        document_id=input_data["document_id"],
