...
@action(
    ...
    input_schema={
        "page_size": {
            "type": "integer",
            "description": "Max calendars to return (capped at 1000).",
            "example": 20,
        },
        "page_token": {
            "type": "string",
...
async def get_lark_calendar(input_data: dict) -> dict:
    ...
    return await run_client(
        "lark_calendar", "get_calendar", calendar_id=input_data["calendar_id"]
    )
...
@action(
    ...
    input_schema={
        "summary": {
            "type": "string",
            "description": "Calendar name (max 255 chars).",
            "example": "Project X",
        },
        "description": {
            "type": "string",
        ...
        "permissions": {
            "type": "string",
            "description": "private | show_only_free_busy | public.",
            "example": "private",
        },
        "color": {
            "type": "integer",
            "description": "Optional RGB int32 (Lark encoding). -1 for default.",
            "example": -1,
        },
        "summary_alias": {
            "type": "string",
            "description": "Optional alias / short name.",
            "example": "",
        },
    },
    output_schema={
...
async def delete_lark_calendar(input_data: dict) -> dict:
    ...
    return await run_client(
        "lark_calendar", "delete_calendar", calendar_id=input_data["calendar_id"]
    )
...
async def subscribe_to_lark_calendar(input_data: dict) -> dict:
    ...
    return await run_client(
        "lark_calendar", "subscribe_calendar", calendar_id=input_data["calendar_id"]
    )
...
async def unsubscribe_from_lark_calendar(input_data: dict) -> dict:
    ...
    return await run_client(
        "lark_calendar", "unsubscribe_calendar", calendar_id=input_data["calendar_id"]
    )
...
@action(
    ...
    input_schema={
        "calendar_id": {
            "type": "string",
            "description": "Calendar id. Use list_lark_calendars or get_lark_primary_calendar to find it.",
            "example": "primary",
        },
        "start_time": {
            "type": "integer",
            "description": "Window start as Unix timestamp in seconds.",
            "example": 1730000000,
        },
        "end_time": {
            "type": "integer",
            "description": "Window end as Unix timestamp in seconds.",
            "example": 1730086400,
        },
        "page_size": {
            "type": "integer",
...
@action(
    ...
    input_schema={
        "calendar_id": {
            "type": "string",
            "description": "Calendar id holding the event.",
            "example": "primary",
        },
        "event_id": {
            "type": "string",
...
@action(
    ...
    input_schema={
        ...
        "start_time": {
            "type": "integer",
            "description": "Start as Unix timestamp in seconds.",
            "example": 1730000000,
        },
        "end_time": {
            "type": "integer",
            "description": "End as Unix timestamp in seconds.",
            "example": 1730003600,
        },
        "description": {
            "type": "string",
            "description": "Event body / agenda.",
            "example": "Review last quarter and align on Q2 goals.",
        },
        "location": {
            "type": "string",
            "description": "Physical or virtual location label.",
            "example": "Conf Room A",
        },
        "with_video_meeting": {
            "type": "boolean",
            "description": "If true, Lark auto-attaches a Lark Meeting URL.",
            "example": False,
        },
    },
    output_schema={
...
@action(
    ...
    input_schema={
        ...
        "summary": {
            "type": "string",
            "description": "New event title (omit to keep).",
            "example": "Q2 planning (rescheduled)",
        },
        "description": {
            "type": "string",
        ...
        "start_time": {
            "type": "integer",
            "description": "New start as Unix seconds (omit to keep).",
            "example": 1730086400,
        },
        "end_time": {
            "type": "integer",
            "description": "New end as Unix seconds (omit to keep).",
            "example": 1730090000,
        },
        "location": {
            "type": "string",
            "description": "New location (omit to keep).",
            "example": "",
        },
    },
    output_schema={
...
@action(
    ...
    input_schema={
        ...
        "need_notification": {
            "type": "boolean",
            "description": "Email attendees about the cancellation.",
            "example": True,
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        ...
        "start_time": {
            "type": "integer",
            "description": "Optional window start as Unix seconds.",
            "example": 1730000000,
        },
        "end_time": {
            "type": "integer",
            "description": "Optional window end as Unix seconds.",
            "example": 1732000000,
        },
        "page_size": {
            "type": "integer",
...
@action(
    ...
    input_schema={
        ...
        "event_id": {
            "type": "string",
            "description": "Master recurring event id.",
            "example": "0123abcd-...",
        },
        "start_time": {
            "type": "integer",
            "description": "Window start as Unix seconds.",
            "example": 1730000000,
        },
        "end_time": {
            "type": "integer",
            "description": "Window end as Unix seconds.",
            "example": 1735689600,
        },
        "page_size": {
            "type": "integer",
...
@action(
    ...
    input_schema={
        ...
        "user_ids": {
            "type": "array",
            "description": "Lark open_ids (ou_...) to invite.",
            "example": ["ou_abc"],
        },
        "emails": {
            "type": "array",
            "description": "Email addresses to invite as external attendees.",
            "example": ["alice@example.com"],
        },
        "chat_ids": {
            "type": "array",
            "description": "Lark group chat_ids (oc_...) — every member gets invited.",
            "example": [],
        },
        "need_notification": {
            "type": "boolean",
            "description": "Email/notify the attendees about the invite.",
            "example": True,
        },
    },
    output_schema={
...
@action(
    ...
    input_schema={
        ...
        "page_size": {
            "type": "integer",
            "description": "Max attendees per page (cap 200).",
            "example": 100,
        },
        "page_token": {
            "type": "string",
...
@action(
    ...
    input_schema={
        ...
        "attendee_ids": {
            "type": "array",
            "description": "List of attendee_id values to remove.",
            "example": ["att_abc"],
        },
        "need_notification": {
            "type": "boolean",
            "description": "Notify removed attendees.",
            "example": True,
        },
    },
    output_schema={
...
@action(
    ...
    input_schema={
        ...
        "attendee_id": {
            "type": "string",
            "description": "Chat-type attendee id.",
            "example": "att_chat_...",
        },
        "page_size": {
            "type": "integer",
            "description": "Max members per page (cap 200).",
            "example": 100,
        },
        "page_token": {
            "type": "string",
...
async def list_lark_event_chat_attendee_members(input_data: dict) -> dict:
    ...
    return await run_client(
        "lark_calendar",
        "list_event_attendee_chat_members",
        calendar_id=input_data["calendar_id"],
        event_id=input_data["event_id"],
...
@action(
    ...
    input_schema={
        ...
        "meeting_room_id": {
            "type": "string",
            "description": "Meeting room (room_id).",
            "example": "omm_...",
        },
        "need_notification": {
            "type": "boolean",
            "description": "Notify meeting room owners.",
            "example": True,
        },
    },
    output_schema={
...
async def list_lark_calendar_acls(input_data: dict) -> dict:
    ...
    return await run_client(
        "lark_calendar", "list_calendar_acls", calendar_id=input_data["calendar_id"]
    )
...
@action(
    ...
    input_schema={
        ...
        "user_id": {
            "type": "string",
            "description": "Lark user open_id (ou_...).",
            "example": "ou_abc",
        },
        "role": {
            "type": "string",
            "description": "owner | reader | writer | free_busy_reader.",
            "example": "reader",
        },
    },
    output_schema={
...
@action(
    ...
    input_schema={
        ...
        "acl_id": {
            "type": "string",
            "description": "ACL entry id (from list_lark_calendar_acls).",
            "example": "user_...",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        "user_ids": {
            "type": "array",
            "description": "List of Lark open_ids (ou_...) to query.",
            "example": ["ou_abc", "ou_def"],
        },
        "start_time": {
            "type": "integer",
            "description": "Window start as Unix timestamp in seconds.",
