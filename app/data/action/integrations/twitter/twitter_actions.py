...
@action(
    ...
    action_sets=["twitter_tweets", "twitter"],
    input_schema={
        "tweet_id": {"type": "string", "description": "Tweet ID.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "tweet_ids": {"type": "array", "description": "List of tweet IDs (max 100).", "example": ["123", "456"]},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def lookup_tweets(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "lookup_tweets", tweet_ids=input_data["tweet_ids"])
...
@action(
    ...
    action_sets=["twitter_tweets", "twitter"],
    input_schema={
        "user_id": {"type": "string", "description": "User ID. Leave empty for self.", "example": ""},
        "max_results": {"type": "integer", "description": "Max mentions.", "example": 10},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["twitter_tweets", "twitter"],
    input_schema={
        "text": {"type": "string", "description": "Your commentary.", "example": "Great point —"},
        "quoted_tweet_id": {"type": "string", "description": "Tweet ID being quoted.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_tweets"],
    input_schema={
        "reply_tweet_id": {"type": "string", "description": "ID of the reply tweet.", "example": "1234567890"},
        "hidden": {"type": "boolean", "description": "True to hide, False to unhide.", "example": True},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_tweets", "twitter"],
    input_schema={
        "text": {"type": "string", "description": "Tweet text.", "example": "Check this out!"},
        "media_ids": {"type": "array", "description": "Up to 4 media_id_string values from upload_twitter_media.", "example": ["1234567890"]},
        "reply_to": {"type": "string", "description": "Optional tweet ID to reply to.", "example": ""},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "tweet_id": {"type": "string", "description": "Tweet ID to unlike.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_engagement"],
    input_schema={
        "tweet_id": {"type": "string", "description": "Original tweet ID that was retweeted.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_engagement", "twitter"],
    input_schema={
        "tweet_id": {"type": "string", "description": "Tweet ID to bookmark.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_engagement"],
    input_schema={
        "tweet_id": {"type": "string", "description": "Tweet ID to remove from bookmarks.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def remove_twitter_bookmark(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "remove_bookmark", tweet_id=input_data["tweet_id"])
...
async def list_twitter_bookmarks(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "list_bookmarks", max_results=input_data.get("max_results", 50))
...
@action(
    ...
    action_sets=["twitter_users", "twitter"],
    input_schema={
        "target_user_id": {"type": "string", "description": "Target user_id (numeric).", "example": "44196397"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def follow_twitter_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "follow_user", target_user_id=input_data["target_user_id"])
...
async def unfollow_twitter_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "unfollow_user", target_user_id=input_data["target_user_id"])
...
@action(
    ...
    input_schema={
        "user_id": {"type": "string", "description": "User ID. Leave empty for self.", "example": ""},
        "max_results": {"type": "integer", "description": "Max users to return.", "example": 100},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    action_sets=["twitter_users"],
    input_schema={
        "target_user_id": {"type": "string", "description": "Target user_id.", "example": "44196397"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
async def block_twitter_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "block_user", target_user_id=input_data["target_user_id"])
...
async def unblock_twitter_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "unblock_user", target_user_id=input_data["target_user_id"])
...
async def mute_twitter_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "mute_user", target_user_id=input_data["target_user_id"])
...
async def unmute_twitter_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "unmute_user", target_user_id=input_data["target_user_id"])
...
@action(
    ...
    input_schema={
        "name": {"type": "string", "description": "List name.", "example": "Tech founders"},
        "description": {"type": "string", "description": "Optional description.", "example": ""},
        "private": {"type": "boolean", "description": "Private list.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "list_id": {"type": "string", "description": "List ID.", "example": "1234567890"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        ...
        "private": {"type": "boolean", "description": "Private flag.", "example": False},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "list_id": {"type": "string", "description": "List ID.", "example": "1234567890"},
        "user_id": {"type": "string", "description": "User ID to add.", "example": "44196397"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "list_id": {"type": "string", "description": "List ID.", "example": "1234567890"},
        "user_id": {"type": "string", "description": "User ID to remove.", "example": "44196397"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    input_schema={
        "list_id": {"type": "string", "description": "List ID.", "example": "1234567890"},
        "max_results": {"type": "integer", "description": "Max tweets.", "example": 100},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
...
@action(
    ...
    input_schema={
        "participant_id": {"type": "string", "description": "Recipient user_id (numeric).", "example": "44196397"},
...
@action(
    ...
    input_schema={
        "dm_conversation_id": {"type": "string", "description": "Conversation ID.", "example": "1234567890-987654321"},
        "text": {"type": "string", "description": "Message text.", "example": "Following up..."},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_dms"],
    input_schema={
        "participant_ids": {"type": "array", "description": "List of user_ids to add.", "example": ["44196397", "987654321"]},
        "text": {"type": "string", "description": "First message.", "example": "Hi everyone"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
...
@action(
    ...
    action_sets=["twitter_dms", "twitter"],
    input_schema={
        "max_results": {"type": "integer", "description": "Max events.", "example": 100},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def list_twitter_dm_events(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client("twitter", "list_dm_events", max_results=input_data.get("max_results", 100))
...
@action(
    ...
    action_sets=["twitter_dms"],
    input_schema={
        "participant_id": {"type": "string", "description": "Other user's user_id.", "example": "44196397"},
        "max_results": {"type": "integer", "description": "Max events.", "example": 100},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
)
async def list_twitter_dm_events_with_user(input_data: dict) -> dict:
    from app.data.action.integrations._helpers import run_client
    return await run_client(
        "twitter", "list_dm_events_with_user",
        participant_id=input_data["participant_id"],
        max_results=input_data.get("max_results", 100),
    )
...
@action(
    ...
    input_schema={
        "file_path": {"type": "string", "description": "Local file path.", "example": "/tmp/image.jpg"},
        "media_category": {"type": "string", "description": "tweet_image | tweet_gif | tweet_video | dm_image | dm_video.", "example": "tweet_image"},
    },
    output_schema={"status": {"type": "string", "example": "success"}},
    parallelizable=False,
)
