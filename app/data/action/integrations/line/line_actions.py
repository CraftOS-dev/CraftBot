...
@action(
    ...
    input_schema={
        "to": {
            "type": "string",
            "description": "Recipient userId / groupId / roomId.",
            "example": "U...",
        },
...
def send_line_message(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "push_text", to=input_data["to"], text=input_data["text"]
    )
...
@action(
    ...
    input_schema={
        "reply_token": {
            "type": "string",
            "description": "Reply token from the webhook event.",
            "example": "",
        },
...
def multicast_line_message(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "multicast_text", to=input_data["to"], text=input_data["text"]
    )
...
@action(
    ...
    input_schema={
        ...
        "messages": {
            "type": "array",
            "description": "Array of LINE message objects.",
            "example": [],
        },
        "notification_disabled": {
            "type": "boolean",
            "description": "Silent delivery (optional).",
            "example": False,
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        ...
        "original_content_url": {
            "type": "string",
            "description": "HTTPS URL to full image.",
            "example": "",
        },
        "preview_image_url": {
            "type": "string",
            "description": "Preview URL (optional, defaults to original).",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        ...
        "original_content_url": {
            "type": "string",
            "description": "HTTPS URL to MP4.",
            "example": "",
        },
        "preview_image_url": {
            "type": "string",
            "description": "Preview HTTPS URL.",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def send_line_sticker(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        sticker_id=input_data["sticker_id"],
    )
...
@action(
    ...
    input_schema={
        ...
        "alt_text": {
            "type": "string",
            "description": "Fallback text shown on devices without Flex support.",
            "example": "New notification",
        },
        "contents": {
            "type": "object",
            "description": "Flex container JSON.",
            "example": {},
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
@action(
    ...
    input_schema={
        ...
        "base_url": {
            "type": "string",
            "description": "Base HTTPS URL of the image set.",
            "example": "",
        },
        "alt_text": {"type": "string", "description": "Alt text.", "example": ""},
        "base_width": {
            "type": "integer",
            "description": "Base width (px).",
            "example": 1040,
        },
        "base_height": {
            "type": "integer",
            "description": "Base height (px).",
            "example": 1040,
        },
...
def send_line_imagemap(input_data: dict) -> dict:
    ...
    return run_client_sync(
        ...
        alt_text=input_data["alt_text"],
        base_width=input_data["base_width"],
        base_height=input_data["base_height"],
...
@action(
    ...
    input_schema={
        "group_id": {
            "type": "string",
            "description": "Group ID (starts with 'C').",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def get_line_group_member_count(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_group_member_count", group_id=input_data["group_id"]
    )
...
@action(
    ...
    input_schema={
        "room_id": {
            "type": "string",
            "description": "Room ID (starts with 'R').",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def get_line_room_member_count(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_room_member_count", room_id=input_data["room_id"]
    )
...
def create_line_rich_menu(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "create_rich_menu", rich_menu=input_data["rich_menu"]
    )
...
def get_line_rich_menu(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_rich_menu", rich_menu_id=input_data["rich_menu_id"]
    )
...
def delete_line_rich_menu(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "delete_rich_menu", rich_menu_id=input_data["rich_menu_id"]
    )
...
@action(
    ...
    input_schema={
        ...
        "file_path": {
            "type": "string",
            "description": "Local PNG or JPEG path.",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def set_line_default_rich_menu(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "set_default_rich_menu", rich_menu_id=input_data["rich_menu_id"]
    )
...
def unlink_line_rich_menu_from_user(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "unlink_rich_menu_from_user", user_id=input_data["user_id"]
    )
...
def bulk_unlink_line_rich_menu(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "bulk_unlink_rich_menu", user_ids=input_data["user_ids"]
    )
...
@action(
    ...
    input_schema={
        ...
        "recipient": {
            "type": "object",
            "description": "Audience recipient spec (optional).",
            "example": {},
        },
        "demographic": {
            "type": "object",
            "description": "Demographic filter (optional).",
            "example": {},
        },
        "limit": {
            "type": "object",
            "description": "Limit spec (optional).",
            "example": {},
        },
        "notification_disabled": {
            "type": "boolean",
...
@action(
    ...
    input_schema={
        "request_id": {
            "type": "string",
            "description": "Request ID from send_line_narrowcast.",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def get_line_narrowcast_progress(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_narrowcast_progress", request_id=input_data["request_id"]
    )
...
@action(
    ...
    input_schema={
        ...
        "audiences": {
            "type": "array",
            "description": "List of {id: user_id} dicts.",
            "example": [],
        },
        "is_ifa_audience": {
            "type": "boolean",
            "description": "True for advertising-ID audience.",
            "example": False,
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def get_line_audience(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_audience", audience_group_id=input_data["audience_group_id"]
    )
...
@action(
    ...
    input_schema={
        ...
        "status": {
            "type": "string",
            "description": "Filter by status: IN_PROGRESS | READY | FAILED | EXPIRED.",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def delete_line_audience(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "delete_audience", audience_group_id=input_data["audience_group_id"]
    )
...
def get_line_message_delivery_stats(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_message_delivery_stats", date=input_data["date"]
    )
...
def get_line_message_event_stats(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "get_message_event_stats", request_id=input_data["request_id"]
    )
...
def set_line_webhook_endpoint(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "set_webhook_endpoint", endpoint=input_data["endpoint"]
    )
...
@action(
    ...
    input_schema={
        "endpoint": {
            "type": "string",
            "description": "Override URL (optional, defaults to configured one).",
            "example": "",
        },
    },
    output_schema={"status": {"type": "string", "example": "success"}},
...
def test_line_webhook_endpoint(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "test_webhook_endpoint", endpoint=input_data.get("endpoint") or None
    )
...
def issue_line_channel_access_token(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line",
        "issue_channel_access_token",
        channel_id=input_data["channel_id"],
        channel_secret=input_data["channel_secret"],
    )
...
def revoke_line_channel_access_token(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "revoke_channel_access_token", access_token=input_data["access_token"]
    )
...
def verify_line_access_token(input_data: dict) -> dict:
    ...
    return run_client_sync(
        "line", "verify_access_token", access_token=input_data["access_token"]
    )
