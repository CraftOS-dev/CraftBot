...
import blockStyles from './ActivityBlocks.module.css'

// ─────────────────────────────────────────────────────────────────────
// Section wrapper used by renderers. Reuses ActivityBlocks' .actionSection /
...
export function Section({ label, children }: SectionProps) {
  return (
    <div className={blockStyles.actionSection}>
      {label && <div className={blockStyles.ioLabel}>{label}</div>}
      {children}
    </div>
  )
}
