# -*- coding: utf-8 -*-
"""GitHub integration — client + credential.
...
Auth (connect / disconnect / status) and all user-facing metadata live in
``providers/github/``. To add another integration, copy this folder and its
provider, and adapt.
"""
