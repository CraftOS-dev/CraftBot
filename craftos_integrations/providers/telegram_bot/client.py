...
class TelegramBotClient(BasePlatformClient):
    ...
    def _extract_attachments(cls, message: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if poll:
            out.append(
                {"kind": "poll", "extra": {"question": poll.get("question", "")}}
            )
        return out
    ...
    async def edit_message_reply_markup(
        ...
        return await _telegram_acall(
            self._api_url("editMessageReplyMarkup"), json=payload
        )
    ...
    async def unpin_all_messages(self, chat_id: Union[int, str]) -> Dict[str, Any]:
        return await _telegram_acall(
            self._api_url("unpinAllChatMessages"), json={"chat_id": chat_id}
        )
    ...
    async def send_chat_action(
        ...
        return await _telegram_acall(
            self._api_url("sendChatAction"), json={"chat_id": chat_id, "action": action}
        )
    ...
    async def send_video(
        ...
        if reply_markup is not None:
            payload["reply_markup"] = reply_markup
        return await _telegram_acall(
            self._api_url("sendVideo"), json=payload, timeout=60.0
        )
    ...
    async def send_audio(
        ...
        if reply_markup is not None:
            payload["reply_markup"] = reply_markup
        return await _telegram_acall(
            self._api_url("sendAudio"), json=payload, timeout=60.0
        )
    ...
    async def send_voice(
        ...
        if duration is not None:
            payload["duration"] = duration
        return await _telegram_acall(
            self._api_url("sendVoice"), json=payload, timeout=60.0
        )
    ...
    async def send_video_note(
        ...
        return await _telegram_acall(
            self._api_url("sendVideoNote"), json=payload, timeout=60.0
        )
    ...
    async def send_animation(
        ...
        if parse_mode:
            payload["parse_mode"] = parse_mode
        return await _telegram_acall(
            self._api_url("sendAnimation"), json=payload, timeout=60.0
        )

    async def send_sticker(
        self, chat_id: Union[int, str], sticker: str, emoji: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    async def send_dice(
        ...
        return await _telegram_acall(
            self._api_url("sendDice"), json={"chat_id": chat_id, "emoji": emoji}
        )
    ...
    async def send_media_group(
        self, chat_id: Union[int, str], media: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
    ...
    async def get_file(self, file_id: str) -> Dict[str, Any]:
        ...
        return await _telegram_acall(
            self._api_url("getFile"), json={"file_id": file_id}
        )
    ...
    async def unban_chat_member(
        self, chat_id: Union[int, str], user_id: int, only_if_banned: bool = True
    ) -> Dict[str, Any]:
        return await _telegram_acall(
            self._api_url("unbanChatMember"),
            json={
                "chat_id": chat_id,
                "user_id": user_id,
    ...
    async def set_chat_administrator_custom_title(
        ...
        return await _telegram_acall(
            self._api_url("setChatAdministratorCustomTitle"),
            json={"chat_id": chat_id, "user_id": user_id, "custom_title": custom_title},
        )

    async def set_chat_permissions(
        self, chat_id: Union[int, str], permissions: Dict[str, Any]
    ) -> Dict[str, Any]:
        return await _telegram_acall(
            self._api_url("setChatPermissions"),
    ...
    async def set_chat_title(
        ...
        return await _telegram_acall(
            self._api_url("setChatTitle"), json={"chat_id": chat_id, "title": title}
        )
    ...
    async def export_chat_invite_link(self, chat_id: Union[int, str]) -> Dict[str, Any]:
        ...
        return await _telegram_acall(
            self._api_url("exportChatInviteLink"), json={"chat_id": chat_id}
        )
    ...
    async def create_chat_invite_link(
        ...
        return await _telegram_acall(
            self._api_url("createChatInviteLink"), json=payload
        )
    ...
    async def revoke_chat_invite_link(
        ...
        return await _telegram_acall(
            self._api_url("revokeChatInviteLink"),
    ...
    async def approve_chat_join_request(
        ...
        return await _telegram_acall(
            self._api_url("approveChatJoinRequest"),
            json={"chat_id": chat_id, "user_id": user_id},
        )
    ...
    async def decline_chat_join_request(
        ...
        return await _telegram_acall(
            self._api_url("declineChatJoinRequest"),
            json={"chat_id": chat_id, "user_id": user_id},
        )

    async def get_chat_administrators(self, chat_id: Union[int, str]) -> Dict[str, Any]:
        return await _telegram_acall(
            self._api_url("getChatAdministrators"), json={"chat_id": chat_id}
        )
    ...
    async def set_my_short_description(
        ...
        if language_code:
            payload["language_code"] = language_code
        return await _telegram_acall(
            self._api_url("setMyShortDescription"), json=payload
        )

    async def set_my_name(
        self, name: str, language_code: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    async def set_my_default_administrator_rights(
        ...
        return await _telegram_acall(
            self._api_url("setMyDefaultAdministratorRights"), json=payload
        )
    ...
    async def get_my_default_administrator_rights(
        ...
        return await _telegram_acall(
            self._api_url("getMyDefaultAdministratorRights"),
