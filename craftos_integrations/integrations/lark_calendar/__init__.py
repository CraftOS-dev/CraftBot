...
class LarkCalendarClient(BasePlatformClient):
    ...
    def get_calendar(self, calendar_id: str) -> Result:
        ...
        return http_request(
            "GET",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}",
            headers=self._headers(),
            expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def delete_calendar(self, calendar_id: str) -> Result:
        ...
        return http_request(
            ...
            expected=(200,),
            transform=lambda d: (
                d.get("data", d) or {"deleted": True, "calendar_id": calendar_id}
            ),
        )

    def search_calendars(
        self, query: str, page_size: int = 20, page_token: str = ""
    ) -> Result:
        ...
        return http_request(
            "POST",
            f"{LARK_API_BASE}/calendar/v4/calendars/search",
            params=params,
            headers=self._headers(),
            json={"query": query},
            expected=(200,),
    ...
    def subscribe_calendar(self, calendar_id: str) -> Result:
        ...
        return http_request(
            "POST",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/subscribe",
            headers=self._headers(),
            expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def unsubscribe_calendar(self, calendar_id: str) -> Result:
        ...
        return http_request(
            "POST",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/unsubscribe",
            headers=self._headers(),
            expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def reply_event(self, calendar_id: str, event_id: str, rsvp_status: str) -> Result:
        """Reply to an event invitation. ``rsvp_status``: accept | decline | tentative."""
        return http_request(
            "POST",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/events/{event_id}/reply",
            headers=self._headers(),
            json={"rsvp_status": rsvp_status},
            expected=(200,),
            transform=lambda d: (
                d.get("data", d) or {"replied": True, "rsvp_status": rsvp_status}
            ),
        )
    ...
    def batch_delete_event_attendees(
        ...
        return http_request(
            "POST",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/events/{event_id}/attendees/batch_delete",
            headers=self._headers(),
            json={
    ...
    def list_event_attendee_chat_members(
        self,
        calendar_id: str,
        event_id: str,
        attendee_id: str,
        ...
        return http_request(
            "GET",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/events/{event_id}/attendees/{attendee_id}/chat_members",
            params=params,
            headers=self._headers(),
            expected=(200,),
            transform=lambda d: d.get("data", d),
    ...
    def list_event_instances(
        ...
        return http_request(
            "GET",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/events/{event_id}/instances",
            params=params,
            headers=self._headers(),
            expected=(200,),
            transform=lambda d: d.get("data", d),
    ...
    def list_calendar_acls(self, calendar_id: str) -> Result:
        ...
        return http_request(
            "GET",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/acls",
            headers=self._headers(),
            expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def create_calendar_acl(
        self, calendar_id: str, user_id: str, role: str = "reader"
    ) -> Result:
    ...
    def delete_calendar_acl(self, calendar_id: str, acl_id: str) -> Result:
        ...
        return http_request(
            "DELETE",
            f"{LARK_API_BASE}/calendar/v4/calendars/{calendar_id}/acls/{acl_id}",
            headers=self._headers(),
            expected=(200,),
