...
class LarkDriveHandler(IntegrationHandler):
    ...
    async def login(self, args: List[str]) -> Tuple[bool, str]:
        if len(args) < 2:
            return False, (
                "Usage: /lark_drive login <app_id> <app_secret>\n"
...
class LarkDriveClient(BasePlatformClient):
    ...
    def copy_file(self, file_token: str, name: str,
                  folder_token: str,
                  copy_type: str = "file") -> Result:
        """Copy a file to a folder. copy_type: file | folder | doc | docx | sheet | bitable | mindnote | slides."""
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/files/{file_token}/copy",
            headers=self._headers(),
    ...
    def move_file(self, file_token: str, target_folder_token: str,
                  file_type: str = "file") -> Result:
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/files/{file_token}/move",
            headers=self._headers(),
    ...
    def list_file_versions(self, file_token: str, file_type: str = "docx",
                           page_size: int = 50,
                           page_token: str = "") -> Result:
        """List version history. file_type: docx | doc | sheet."""
        params: Dict[str, str] = {"obj_type": file_type, "page_size": str(min(page_size, 50))}
        if page_token: params["page_token"] = page_token
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/files/{file_token}/versions",
    ...
    def file_statistics(self, file_token: str, file_type: str = "docx") -> Result:
        ...
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/files/{file_token}/statistics",
            headers=self._headers(),
            params={"file_type": file_type}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def list_permission_members(self, file_token: str,
                                file_type: str = "docx") -> Result:
        """List who has access. file_type: doc | docx | sheet | bitable | file | folder | mindnote | slides."""
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/permissions/{file_token}/members",
            headers=self._headers(),
            params={"type": file_type}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def add_permission_member(self, file_token: str,
                              member_type: str, member_id: str,
                              perm: str, file_type: str = "docx",
                              perm_type: str = "container",
                              notify_lark: bool = False) -> Result:
        ...
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/permissions/{file_token}/members",
            headers=self._headers(),
            params={"type": file_type, "need_notification": str(notify_lark).lower()},
            json={"member_type": member_type, "member_id": member_id,
                  "perm": perm, "perm_type": perm_type},
            expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def update_permission_member(self, file_token: str, member_id: str,
                                 member_type: str, perm: str,
                                 file_type: str = "docx",
                                 perm_type: str = "container",
                                 notify_lark: bool = False) -> Result:
        return http_request(
            "PUT", f"{LARK_API_BASE}/drive/v1/permissions/{file_token}/members/{member_id}",
            headers=self._headers(),
            params={"type": file_type, "need_notification": str(notify_lark).lower()},
    ...
    def delete_permission_member(self, file_token: str, member_id: str,
                                 member_type: str,
                                 file_type: str = "docx") -> Result:
        return http_request(
            "DELETE", f"{LARK_API_BASE}/drive/v1/permissions/{file_token}/members/{member_id}",
            headers=self._headers(),
            params={"type": file_type, "member_type": member_type},
            expected=(200,),
            transform=lambda d: d.get("data", {"removed": True, "member_id": member_id}),
        )

    def get_public_permission(self, file_token: str,
                              file_type: str = "docx") -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v2/permissions/{file_token}/public",
            headers=self._headers(),
            params={"type": file_type}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def update_public_permission(self, file_token: str,
                                 file_type: str = "docx",
                                 ...
                                 invite_external: Optional[bool] = None) -> Result:
        ...
        if external_access_entity is not None: payload["external_access_entity"] = external_access_entity
        if security_entity is not None: payload["security_entity"] = security_entity
        if comment_entity is not None: payload["comment_entity"] = comment_entity
        if share_entity is not None: payload["share_entity"] = share_entity
        if link_share_entity is not None: payload["link_share_entity"] = link_share_entity
        if invite_external is not None: payload["invite_external"] = invite_external
        return http_request(
            "PATCH", f"{LARK_API_BASE}/drive/v2/permissions/{file_token}/public",
            headers=self._headers(),
            params={"type": file_type},
    ...
    def transfer_owner(self, file_token: str, member_type: str, member_id: str,
                       file_type: str = "docx",
                       remove_old_owner: bool = False) -> Result:
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/permissions/{file_token}/members/transfer_owner",
            headers=self._headers(),
            params={"type": file_type,
    ...
    def list_comments(self, file_token: str, file_type: str = "docx",
                      is_whole: bool = True,
                      page_size: int = 100,
                      page_token: str = "") -> Result:
        ...
        if page_token: params["page_token"] = page_token
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/files/{file_token}/comments",
            headers=self._headers(), params=params, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def create_comment(self, file_token: str, content_elements: List[Dict[str, Any]],
                       file_type: str = "docx") -> Result:
        """content_elements is a list of rich-text element dicts (text_run, mention, link, etc.)."""
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/files/{file_token}/comments",
            headers=self._headers(),
            params={"file_type": file_type},
            json={"reply_list": {"replies": [{"content": {"elements": content_elements}}]}},
            expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def get_comment(self, file_token: str, comment_id: str,
                    file_type: str = "docx") -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/files/{file_token}/comments/{comment_id}",
            headers=self._headers(),
            params={"file_type": file_type}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def resolve_comment(self, file_token: str, comment_id: str,
                        file_type: str = "docx",
                        is_solved: bool = True) -> Result:
        return http_request(
            "PATCH", f"{LARK_API_BASE}/drive/v1/files/{file_token}/comments/{comment_id}",
            headers=self._headers(),
            params={"file_type": file_type},
            json={"is_solved": is_solved}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def list_comment_replies(self, file_token: str, comment_id: str,
                             file_type: str = "docx",
                             page_size: int = 100) -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/files/{file_token}/comments/{comment_id}/replies",
            headers=self._headers(),
    ...
    def update_comment_reply(self, file_token: str, comment_id: str, reply_id: str,
        ...
        return http_request(
            ...
            headers=self._headers(),
            params={"file_type": file_type},
            json={"content": {"elements": content_elements}}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def delete_comment_reply(self, file_token: str, comment_id: str, reply_id: str,
                             file_type: str = "docx") -> Result:
        return http_request(
            "DELETE",
            f"{LARK_API_BASE}/drive/v1/files/{file_token}/comments/{comment_id}/replies/{reply_id}",
    ...
    def create_import_task(self, file_extension: str, file_name: str,
                           file_token: str, file_type: str,
                           point_type: str = "ccm_import_open_platform",
                           folder_token: str = "") -> Result:
        ...
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/import_tasks",
    ...
    def get_import_task(self, ticket: str) -> Result:
        ...
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/import_tasks/{ticket}",
            headers=self._headers(), expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def create_export_task(self, file_extension: str, file_token: str,
                           file_type: str,
                           sub_id: str = "") -> Result:
        ...
        return http_request(
            "POST", f"{LARK_API_BASE}/drive/v1/export_tasks",
            headers=self._headers(), json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_export_task(self, ticket: str, file_token: str) -> Result:
        ...
        return http_request(
            "GET", f"{LARK_API_BASE}/drive/v1/export_tasks/{ticket}",
            headers=self._headers(),
            params={"token": file_token}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def download_export(self, result_file_token: str, dest_path: str) -> Result:
        ...
        try:
            with httpx.stream(
                "GET", f"{LARK_API_BASE}/drive/v1/export_tasks/file/{result_file_token}/download",
                headers={"Authorization": f"Bearer {token}"},
                timeout=120.0,
            ) as resp:
                if resp.status_code != 200:
    ...
    def create_document(self, title: str = "",
        ...
        return http_request(
            "POST", f"{LARK_API_BASE}/docx/v1/documents",
            headers=self._headers(), json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_document(self, document_id: str) -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/docx/v1/documents/{document_id}",
            headers=self._headers(), expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_document_raw_content(self, document_id: str, lang: int = 0) -> Result:
        ...
        return http_request(
            "GET", f"{LARK_API_BASE}/docx/v1/documents/{document_id}/raw_content",
            headers=self._headers(),
            params={"lang": lang}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def list_document_blocks(self, document_id: str,
                             page_size: int = 500,
                             page_token: str = "",
                             document_revision_id: int = -1) -> Result:
        params: Dict[str, str] = {
        ...
        if page_token: params["page_token"] = page_token
        return http_request(
            "GET", f"{LARK_API_BASE}/docx/v1/documents/{document_id}/blocks",
            headers=self._headers(), params=params, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def get_document_block(self, document_id: str, block_id: str,
                           document_revision_id: int = -1) -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/docx/v1/documents/{document_id}/blocks/{block_id}",
            headers=self._headers(),
    ...
    def create_document_block_children(self, document_id: str, block_id: str,
        ...
        return http_request(
            ...
            headers=self._headers(),
            params={"document_revision_id": str(document_revision_id)},
            json={"children": children, "index": index}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def update_document_block(self, document_id: str, block_id: str,
        ...
        return http_request(
            ...
            headers=self._headers(),
            params={"document_revision_id": str(document_revision_id)},
            json=update_payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def batch_update_document_blocks(self, document_id: str,
        ...
        return http_request(
            ...
            headers=self._headers(),
            params={"document_revision_id": str(document_revision_id)},
            json={"requests": requests}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def delete_document_blocks(self, document_id: str, block_id: str,
    ...
    def create_spreadsheet(self, title: str = "",
        ...
        if folder_token: payload["folder_token"] = folder_token
        return http_request(
            "POST", f"{LARK_API_BASE}/sheets/v3/spreadsheets",
            headers=self._headers(), json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_spreadsheet(self, spreadsheet_token: str) -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/sheets/v3/spreadsheets/{spreadsheet_token}",
            headers=self._headers(), expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def update_spreadsheet_title(self, spreadsheet_token: str,
                                 title: str) -> Result:
        return http_request(
            "PATCH", f"{LARK_API_BASE}/sheets/v3/spreadsheets/{spreadsheet_token}",
            headers=self._headers(),
            json={"title": title}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_spreadsheet_sheet(self, spreadsheet_token: str,
                              sheet_id: str) -> Result:
        return http_request(
            "GET",
    ...
    def get_sheet_values(self, spreadsheet_token: str, range_: str,
                         value_render_option: str = "ToString",
                         date_time_render_option: str = "FormattedString") -> Result:
    ...
    def batch_get_sheet_values(self, spreadsheet_token: str,
                               ranges: List[str],
                               value_render_option: str = "ToString") -> Result:
        return http_request(
            "GET",
    ...
    def update_sheet_values(self, spreadsheet_token: str, range_: str,
                            values: List[List[Any]]) -> Result:
    ...
    def append_sheet_values(self, spreadsheet_token: str, range_: str,
                            values: List[List[Any]],
                            insert_data_option: str = "OVERWRITE") -> Result:
    ...
    def batch_update_sheet_values(self, spreadsheet_token: str,
                                  value_ranges: List[Dict[str, Any]]) -> Result:
    ...
    def find_in_sheet(self, spreadsheet_token: str, sheet_id: str,
                      find_text: str, range_: str,
                      match_case: bool = False,
                      match_entire_cell: bool = False,
                      search_by_regex: bool = False,
                      include_formulas: bool = False) -> Result:
        return http_request(
            "POST",
    ...
    def replace_in_sheet(self, spreadsheet_token: str, sheet_id: str,
                         find_text: str, replacement: str, range_: str,
                         match_case: bool = False,
                         match_entire_cell: bool = False,
                         search_by_regex: bool = False,
                         include_formulas: bool = False) -> Result:
    ...
    def insert_sheet_dimension_range(self, spreadsheet_token: str, sheet_id: str,
                                     major_dimension: str,
                                     start_index: int, end_index: int,
                                     inherit_style: str = "BEFORE") -> Result:
    ...
    def create_bitable_app(self, name: str = "",
                           folder_token: str = "",
                           time_zone: str = "Asia/Shanghai") -> Result:
        payload: Dict[str, Any] = {"time_zone": time_zone}
        if name: payload["name"] = name
        if folder_token: payload["folder_token"] = folder_token
        return http_request(
            "POST", f"{LARK_API_BASE}/bitable/v1/apps",
            headers=self._headers(), json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_bitable_app(self, app_token: str) -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/bitable/v1/apps/{app_token}",
            headers=self._headers(), expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def update_bitable_app(self, app_token: str,
                           name: Optional[str] = None,
                           is_advanced: Optional[bool] = None) -> Result:
        payload: Dict[str, Any] = {}
        if name is not None: payload["name"] = name
        if is_advanced is not None: payload["is_advanced"] = is_advanced
        return http_request(
            "PUT", f"{LARK_API_BASE}/bitable/v1/apps/{app_token}",
            headers=self._headers(), json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def list_bitable_tables(self, app_token: str, page_size: int = 100,
                            page_token: str = "") -> Result:
        params: Dict[str, str] = {"page_size": str(min(page_size, 100))}
        if page_token: params["page_token"] = page_token
        return http_request(
            "GET", f"{LARK_API_BASE}/bitable/v1/apps/{app_token}/tables",
            headers=self._headers(), params=params, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def create_bitable_table(self, app_token: str, name: str,
                             default_view_name: Optional[str] = None,
                             fields: Optional[List[Dict[str, Any]]] = None) -> Result:
        payload_table: Dict[str, Any] = {"name": name}
        if default_view_name: payload_table["default_view_name"] = default_view_name
        if fields: payload_table["fields"] = fields
        return http_request(
            "POST", f"{LARK_API_BASE}/bitable/v1/apps/{app_token}/tables",
            headers=self._headers(),
            json={"table": payload_table}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def list_bitable_records(self, app_token: str, table_id: str,
                             ...
                             page_size: int = 100,
                             page_token: str = "",
                             field_names: Optional[List[str]] = None) -> Result:
    ...
    def get_bitable_record(self, app_token: str, table_id: str,
    ...
    def create_bitable_record(self, app_token: str, table_id: str,
                              fields: Dict[str, Any]) -> Result:
        return http_request(
            "POST",
            f"{LARK_API_BASE}/bitable/v1/apps/{app_token}/tables/{table_id}/records",
            headers=self._headers(),
            json={"fields": fields}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def delete_bitable_record(self, app_token: str, table_id: str,
                              record_id: str) -> Result:
        return http_request(
            "DELETE",
            f"{LARK_API_BASE}/bitable/v1/apps/{app_token}/tables/{table_id}/records/{record_id}",
            headers=self._headers(), expected=(200,),
            transform=lambda d: d.get("data", {"deleted": True, "record_id": record_id}),
        )

    def batch_create_bitable_records(self, app_token: str, table_id: str,
        ...
        return http_request(
            ...
            headers=self._headers(),
            json={"records": records}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def search_bitable_records(self, app_token: str, table_id: str,
        ...
        payload: Dict[str, Any] = {}
        if filter_obj is not None: payload["filter"] = filter_obj
        if sort is not None: payload["sort"] = sort
        if field_names is not None: payload["field_names"] = field_names
        ...
        return http_request(
            ...
            headers=self._headers(),
            params=params, json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def list_bitable_fields(self, app_token: str, table_id: str,
                            view_id: str = "",
                            page_size: int = 100,
                            page_token: str = "") -> Result:
        params: Dict[str, str] = {"page_size": str(min(page_size, 100))}
    ...
    def create_bitable_field(self, app_token: str, table_id: str,
                             field_name: str, field_type: int,
                             property: Optional[Dict[str, Any]] = None,
                             description: Optional[Dict[str, Any]] = None) -> Result:
    ...
    def list_bitable_views(self, app_token: str, table_id: str,
                           page_size: int = 100) -> Result:
        return http_request(
            "GET",
            f"{LARK_API_BASE}/bitable/v1/apps/{app_token}/tables/{table_id}/views",
            headers=self._headers(),
            params={"page_size": str(min(page_size, 100))}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def list_wiki_spaces(self, page_size: int = 50,
                         page_token: str = "") -> Result:
        params: Dict[str, str] = {"page_size": str(min(page_size, 50))}
        if page_token: params["page_token"] = page_token
        return http_request(
            "GET", f"{LARK_API_BASE}/wiki/v2/spaces",
            headers=self._headers(), params=params, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_wiki_space(self, space_id: str) -> Result:
        return http_request(
            "GET", f"{LARK_API_BASE}/wiki/v2/spaces/{space_id}",
            headers=self._headers(), expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def list_wiki_nodes(self, space_id: str,
        ...
        if page_token: params["page_token"] = page_token
        return http_request(
            "GET", f"{LARK_API_BASE}/wiki/v2/spaces/{space_id}/nodes",
            headers=self._headers(), params=params, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def get_wiki_node(self, token: str, obj_type: str = "wiki") -> Result:
        ...
        return http_request(
            "GET", f"{LARK_API_BASE}/wiki/v2/spaces/get_node",
            headers=self._headers(),
            params={"token": token, "obj_type": obj_type}, expected=(200,),
            transform=lambda d: d.get("data", d),
        )

    def create_wiki_node(self, space_id: str,
                         obj_type: str, node_type: str = "origin",
                         parent_node_token: str = "",
        ...
        if parent_node_token: payload["parent_node_token"] = parent_node_token
        if origin_node_token: payload["origin_node_token"] = origin_node_token
        if title: payload["title"] = title
        return http_request(
            "POST", f"{LARK_API_BASE}/wiki/v2/spaces/{space_id}/nodes",
            headers=self._headers(), json=payload, expected=(200,),
            transform=lambda d: d.get("data", d),
        )
    ...
    def move_wiki_node(self, space_id: str, node_token: str,
                       ...
                       target_space_id: str = "") -> Result:
        payload: Dict[str, Any] = {}
        if target_parent_token: payload["target_parent_token"] = target_parent_token
        if target_space_id: payload["target_space_id"] = target_space_id
        return http_request(
            "POST",
