...
class GoogleDocsClient(GoogleApiClientMixin, BasePlatformClient):
    ...
    def _batch_update(self, document_id: str, requests: List[Dict[str, Any]],
        ...
        return http_request(
            ...
            expected=(200,),
            transform=transform or (lambda d: {"document_id": document_id, "replies": d.get("replies", [])}),
        )
    ...
    def insert_text(self, document_id: str, text: str, index: int) -> Result:
        ...
        return self._batch_update(document_id, [
            {"insertText": {"location": {"index": index}, "text": text}}
        ], transform=lambda _d: {"inserted": True, "document_id": document_id, "index": index})

    def delete_content_range(self, document_id: str, start_index: int, end_index: int) -> Result:
        return self._batch_update(document_id, [
    ...
    def update_text_style(self, document_id: str, start_index: int, end_index: int,
                          ...
                          font_size_pt: Optional[float] = None, font_family: Optional[str] = None,
                          foreground_color_hex: Optional[str] = None,
                          background_color_hex: Optional[str] = None,
                          link_url: Optional[str] = None) -> Result:
        ...
        fields: List[str] = []
        if bold is not None:
            text_style["bold"] = bold; fields.append("bold")
        if italic is not None:
            text_style["italic"] = italic; fields.append("italic")
        if underline is not None:
            text_style["underline"] = underline; fields.append("underline")
        if strikethrough is not None:
            text_style["strikethrough"] = strikethrough; fields.append("strikethrough")
        ...
        if foreground_color_hex is not None:
            text_style["foregroundColor"] = {"color": {"rgbColor": _hex_to_rgb(foreground_color_hex)}}
            fields.append("foregroundColor")
        if background_color_hex is not None:
            text_style["backgroundColor"] = {"color": {"rgbColor": _hex_to_rgb(background_color_hex)}}
            fields.append("backgroundColor")
        if link_url is not None:
            text_style["link"] = {"url": link_url}; fields.append("link")
        if not fields:
    ...
    def update_paragraph_style(self, document_id: str, start_index: int, end_index: int,
                               ...
                               keep_with_next: Optional[bool] = None) -> Result:
        ...
        if named_style_type is not None:
            para_style["namedStyleType"] = named_style_type; fields.append("namedStyleType")
        if alignment is not None:
            para_style["alignment"] = alignment; fields.append("alignment")
        if line_spacing is not None:
            para_style["lineSpacing"] = line_spacing; fields.append("lineSpacing")
        if keep_with_next is not None:
            para_style["keepWithNext"] = keep_with_next; fields.append("keepWithNext")
        if not fields:
            return {"error": "no_style_fields"}
        return self._batch_update(document_id, [
    ...
    def create_paragraph_bullets(self, document_id: str, start_index: int, end_index: int,
                                 bullet_preset: str = "BULLET_DISC_CIRCLE_SQUARE") -> Result:
    ...
    def delete_paragraph_bullets(self, document_id: str, start_index: int, end_index: int) -> Result:
        return self._batch_update(document_id, [
    ...
    def insert_table(self, document_id: str, rows: int, columns: int, index: int) -> Result:
        return self._batch_update(document_id, [
            {"insertTable": {
                "rows": rows,
                "columns": columns,
        ...
        ], transform=lambda _d: {"table_inserted": True, "document_id": document_id, "rows": rows, "columns": columns})

    def insert_table_row(self, document_id: str, table_start_index: int,
                         row_index: int, column_index: int, insert_below: bool = True) -> Result:
        return self._batch_update(document_id, [
            {"insertTableRow": {
                "tableCellLocation": {
    ...
    def insert_table_column(self, document_id: str, table_start_index: int,
                            row_index: int, column_index: int, insert_right: bool = True) -> Result:
        return self._batch_update(document_id, [
            {"insertTableColumn": {
                "tableCellLocation": {
                    "tableStartLocation": {"index": table_start_index},
    ...
    def delete_table_row(self, document_id: str, table_start_index: int,
                         row_index: int, column_index: int) -> Result:
        return self._batch_update(document_id, [
            {"deleteTableRow": {
                "tableCellLocation": {
                    "tableStartLocation": {"index": table_start_index},
    ...
    def delete_table_column(self, document_id: str, table_start_index: int,
                            row_index: int, column_index: int) -> Result:
        return self._batch_update(document_id, [
            {"deleteTableColumn": {
                "tableCellLocation": {
    ...
    def merge_table_cells(self, document_id: str, table_start_index: int,
                          row_index: int, column_index: int,
                          row_span: int, column_span: int) -> Result:
        return self._batch_update(document_id, [
    ...
    def unmerge_table_cells(self, document_id: str, table_start_index: int,
                            row_index: int, column_index: int,
                            row_span: int, column_span: int) -> Result:
        return self._batch_update(document_id, [
    ...
    def insert_inline_image(self, document_id: str, image_uri: str, index: int,
                            width_pt: Optional[float] = None,
                            height_pt: Optional[float] = None) -> Result:
        req: Dict[str, Any] = {
            "uri": image_uri,
            "location": {"index": index},
        }
        ...
        return self._batch_update(document_id, [
            ...
            "document_id": document_id,
            "image_object_id": (d.get("replies") or [{}])[0].get("insertInlineImage", {}).get("objectId"),
        })

    def replace_image(self, document_id: str, image_object_id: str, image_uri: str) -> Result:
        return self._batch_update(document_id, [
    ...
    def insert_page_break(self, document_id: str, index: int) -> Result:
        ...
        ], transform=lambda _d: {"page_break_inserted": True, "document_id": document_id})

    def insert_section_break(self, document_id: str, index: int,
                             section_type: str = "NEXT_PAGE") -> Result:
        ...
        ], transform=lambda _d: {"section_break_inserted": True, "document_id": document_id})
    ...
    def create_header(self, document_id: str, header_type: str = "DEFAULT") -> Result:
        return self._batch_update(document_id, [
            ...
            "document_id": document_id,
            "header_id": (d.get("replies") or [{}])[0].get("createHeader", {}).get("headerId"),
        })
    ...
    def create_footer(self, document_id: str, footer_type: str = "DEFAULT") -> Result:
        return self._batch_update(document_id, [
            ...
            "document_id": document_id,
            "footer_id": (d.get("replies") or [{}])[0].get("createFooter", {}).get("footerId"),
        })
    ...
    def create_named_range(self, document_id: str, name: str,
                           start_index: int, end_index: int) -> Result:
        return self._batch_update(document_id, [
            {"createNamedRange": {
                "name": name,
                "range": {"startIndex": start_index, "endIndex": end_index},
            ...
            "document_id": document_id,
            "named_range_id": (d.get("replies") or [{}])[0].get("createNamedRange", {}).get("namedRangeId"),
        })

    def delete_named_range(self, document_id: str, name: Optional[str] = None,
                           named_range_id: Optional[str] = None) -> Result:
        if name:
    ...
    def copy_document(self, document_id: str, new_title: str) -> Result:
        ...
        return http_request(
            "POST", f"{DRIVE_API_BASE}/files/{document_id}/copy",
            headers=self._headers(),
            json={"name": new_title},
            expected=(200,),
            transform=lambda d: {
    ...
    def export_document(self, document_id: str, mime_type: str, dest_path: str) -> Result:
        ...
        try:
            with httpx.stream(
                ...
                if r.status_code != 200:
                    return {"error": f"http_{r.status_code}", "details": r.read().decode("utf-8", "replace")[:300]}
                with open(dest_path, "wb") as fh:
                    for chunk in r.iter_bytes():
                        fh.write(chunk)
            return {"ok": True, "result": {"saved_to": dest_path, "document_id": document_id, "mime_type": mime_type}}
