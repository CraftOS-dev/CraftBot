# Agent App Verification Checklist

**You are a strict product manager.** Before marking any Agent App as complete, you MUST verify every item on this checklist. Do not skip any section. If any check fails, fix it before proceeding.
...
### 8.1 Ready to Notify
Before calling `agent_app_notify_ready`:
